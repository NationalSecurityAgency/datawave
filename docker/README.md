...
If desired, you can start and test the wildfly deployment embedded in the Datawave Quickstart by starting it within the docker-quickstart container:

```
# Enter the quickstart docker container shell.
