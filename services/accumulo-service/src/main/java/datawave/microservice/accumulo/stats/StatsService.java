...
/**
 * This service implements Accumulo stats retrieval by using a {@link RestTemplate} client to fetch the Accumulo monitor servlet's XML response, which it then
 * deserializes into a {@link StatsResponse} instance as the stats service client response
 *
 * <p>
...
public class StatsService {
    ...
    public synchronized void discoverAccumuloMonitor() {
        try {
            ...
            log.error("Failed to discover Accumulo monitor location", t);
        }
    }
    ...
    public synchronized StatsResponse getStats() {
        ...
        try {
            ...
            log.error("Failed to retrieve stats from Accumulo", t);
    ...
    /**
     * {@link XMLFilterImpl} subclass that will inject the given namespace URI into XML retrieved from the Accumulo monitor
     */
