...
/**
 * This service provides utility methods for common Accumulo system operations
 */
@Service
...
public class AdminService {
    ...
    public VoidResponse grantSystemPermission(String userName, String permission) {
        ...
        try {
            ...
            log.error("Failed to grant " + permission + " to user " + userName, t);
    ...
    public VoidResponse createTable(String tableName) {
        ...
        try {
            ...
            log.error("Table creation failed for table: " + tableName, t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public VoidResponse flushTable(String tableName) {
        ...
        try {
            ...
            log.error("Table flush failed for table: " + tableName, t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public VoidResponse setTableProperty(String tableName, String propertyName, String propertyValue) {
        ...
        try {
            ...
            log.error("Failed to set property: " + propertyName + ", value: " + propertyValue + ", table: " + tableName, t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public VoidResponse removeTableProperty(String tableName, String propertyName) {
        ...
        try {
            ...
            log.error("Failed to remove property: " + propertyName + ", table: " + tableName, t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public ListTablesResponse listTables() {
        ...
        try {
            ...
            log.error("Failed to retrieve table list", t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public ListUserAuthorizationsResponse listUserAuthorizations(String userName) {
        ...
        try {
            ...
            log.error("Failed to retrieve authorizations for user: " + userName, t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public ListUserPermissionsResponse listUserPermissions(String userName) {
        ...
        try {
            ...
            log.error("Failed to retrieve permissions for user: " + userName, t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public ListUsersResponse listUsers() {
        ...
        try {
            ...
            log.error("Failed to retrieve Accumulo users", t);
            throw new RuntimeException(t);
        }
        return response;
    }
    ...
    public UpdateResponse updateAccumulo(UpdateRequest request) {
        ...
        try {
            ...
            log.error("Update operation encountered error(s)", t);
            throw new RuntimeException(t);
        }
    }
    ...
    public ValidateVisibilityResponse validateVisibilities(String[] visibilityArray) {
        ...
        try {
            ...
            log.error("ValidateVisibilities operation failed", t);
            throw new RuntimeException(t);
        }
    }
}
