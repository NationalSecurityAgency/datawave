...
public class AdminServiceTest {
    ...
    public void testGrantAndListSystemPermissions() {
        // Test /GrantSystemPermission via AdminController
    ...
    public void testValidateVisibilities() {
        ...
        // 3 good ones, one bad
        String[] visibilities = new String[] {"A|(B&C&D&E&F)", "A|B|C", "A&B&C", "THIS:^IS||N@T%VALID"};
        ValidateVisibilityResponse response = th.assert200Status(th.createPostRequest("/ValidateVisibilities", visibilities), ValidateVisibilityResponse.class);
