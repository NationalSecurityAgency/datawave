package nsa.datawave.ingest.mapreduce.handler.dateindex;
...
import nsa.datawave.ingest.data.RawRecordContainerImplTest;
import nsa.datawave.ingest.data.TypeRegistry;
import nsa.datawave.ingest.data.config.BaseNormalizedContent;
...
import nsa.datawave.ingest.table.config.DateIndexTableConfigHelper;
