...
import nsa.datawave.ingest.mapreduce.job.TableConfigHelperFactory;
...
public class TableConfigHelperFactoryTest {
    ...
    public void shouldSetupTableWithOverrides() throws Exception {
        ...
        assertThat(testShardProperties.get("table.iterator.majc.agg"), is("10,nsa.datawave.iterators.PropogatingIterator"));
    ...
    public void shouldSetupTablesWithoutOverrides() throws Exception {
        ...
        assertThat(shardProperties.get("table.iterator.majc.agg"), is("10,nsa.datawave.iterators.PropogatingIterator"));
    }
}
