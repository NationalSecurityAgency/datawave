...
public class FieldConfigHelperTest {
    ...
    public void testBadTag() throws Exception {
        String input = "<?xml version=\"1.0\"?>\n"
                        + "<fieldConfig>\n"
                        + "    <default stored=\"true\" indexed=\"false\" reverseIndexed=\"false\" tokenized=\"true\" reverseTokenized=\"true\" indexType=\"nsa.datawave.data.type.LcNoDiacriticsType\"/>\n"
                        + "    <nomatch stored=\"true\" indexed=\"true\" reverseIndexed=\"true\" tokenized=\"true\"  reverseTokenized=\"true\" indexType=\"nsa.datawave.data.type.HexStringType\"/>\n"
    ...
    public void testIncompleteDefault() throws Exception {
        String input = "<?xml version=\"1.0\"?>\n"
                        + "<fieldConfig>\n"
                        + "    <default stored=\"true\" reverseIndexed=\"false\" tokenized=\"true\" reverseTokenized=\"true\" indexType=\"nsa.datawave.data.type.LcNoDiacriticsType\"/>\n"
                        + "    <nomatch stored=\"true\" indexed=\"true\" reverseIndexed=\"true\" tokenized=\"true\"  reverseTokenized=\"true\" indexType=\"nsa.datawave.data.type.HexStringType\"/>\n"
                        + "    <fieldPattern pattern=\"*J\" indexed=\"true\" indexType=\"nsa.datawave.data.type.MacAddressType\"/>\n"
                        + "    <field name=\"A\" indexed=\"true\"/>\n" +
    ...
    public void testIncompleteNomatch() throws Exception {
        String input = "<?xml version=\"1.0\"?>\n"
                        + "<fieldConfig>\n"
                        + "    <default stored=\"true\" indexed=\"false\" reverseIndexed=\"false\" tokenized=\"true\" reverseTokenized=\"true\" indexType=\"nsa.datawave.data.type.LcNoDiacriticsType\"/>\n"
                        + "    <nomatch stored=\"true\" reverseIndexed=\"true\" tokenized=\"true\"  reverseTokenized=\"true\" indexType=\"nsa.datawave.data.type.HexStringType\"/>\n"
                        + "    <fieldPattern pattern=\"*J\" indexed=\"true\" indexType=\"nsa.datawave.data.type.MacAddressType\"/>\n"
                        + "    <field name=\"H\" indexType=\"nsa.datawave.data.type.DateType\"/>\n" + "</fieldConfig>";
