...
public class EventMetadataTest {
    ...
    private static final String TF = ShardFamilyConstants.TF;
    private static final String T = MetadataFamilyConstants.T;
    private static final String E = MetadataFamilyConstants.E;
    private static final String I = MetadataFamilyConstants.I;
