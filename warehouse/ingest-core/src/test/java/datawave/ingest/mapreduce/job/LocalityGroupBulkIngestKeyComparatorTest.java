...
public class LocalityGroupBulkIngestKeyComparatorTest {
    ...
    static Stream<Arguments> data() {
        return Stream.of(
            Arguments.arguments(COMP_EQ, new Object[] {"t1", "r1", "cf1", "cq1", "cv", 0L}, new Object[] { "t1", "r1", "cf1", "cq1", "cv", 0L }, new String[] { "lg" }),
            Arguments.arguments(COMP_LT, new Object[] {"t1", "r1", "cf1", "cq1", "cv", 0L}, new Object[] { "t2", "r1", "cf1", "cq1", "cv", 0L }, new String[] { "lg" }),
            Arguments.arguments(COMP_LT, new Object[] {"t1", "r1", "cf1", "cq1", "cv", 0L}, new Object[] { "t1", "r2", "cf1", "cq1", "cv", 0L }, new String[] { "lg" }),
            Arguments.arguments(COMP_LT, new Object[] {"t1", "r1", "cf1", "cq1", "cv", 0L}, new Object[] { "t1", "r1", "cf2", "cq1", "cv", 0L }, new String[] { "lg" }),
            Arguments.arguments(COMP_LT, new Object[] {"t1", "r1", "cf1", "cq1", "cv", 0L}, new Object[] { "t1", "r1", "cf1", "cq2", "cv", 0L }, new String[] { "lg" }),
            Arguments.arguments(COMP_LT, new Object[] {"t1", "r1", "cf1", "cq1", "cv", 0L}, new Object[] { "t1", "r1", "cf1", "cq1", "cv1", 0L }, new String[] { "lg" }),

            // lg cf2 and default lg - cf2 should be sorted before cf1
            Arguments.arguments(COMP_LT, new Object[] {"t1", "r1", "cf2", "cq1", "cv", 0L}, new Object[] { "t1", "r1", "cf1", "cq1", "cv", 0L }, new String[] { "lg=cf2" }),

            // default lg and lg cf1 - cf2 should be sorted after cf1
            Arguments.arguments(COMP_GT, new Object[] {"t1", "r1", "cf2", "cq1", "cv", 0L}, new Object[] { "t1", "r1", "cf1", "cq1", "cv", 0L }, new String[] { "lg=cf1" })
    ...
    private static BulkIngestKey newKey(String table, String row, String cf, String cq, String cv, long ts) {
        return new BulkIngestKey(new Text(table), Key.builder()
            .row(row)
            .family(cf)
            .qualifier(cq)
            .visibility(cv)
