...
public class BulkIngestMapFileLoaderTest {
    ...
    // int procResults = proc.waitFor();
    //
    // Assertions.assertEquals("BulkIngestMapLoader#main failed to return the expected value.", ProcessUtils.SYSTEM_EXIT_MINUS_TWO, procResults);
    //
    // List<String> stdOut = ProcessUtils.getStandardOutDumps(proc);
    //
    ...
    // String msg = ioe.getMessage();
    //
    // Assertions.assertTrue("BulkIngestMapFileLoader#markSourceFilesLoaded failed to throw the excepted IOException.",
