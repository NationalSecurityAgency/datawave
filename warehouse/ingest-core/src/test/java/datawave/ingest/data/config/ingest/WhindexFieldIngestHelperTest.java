...
class WhindexFieldIngestHelperTest {
    ...
    void testWhindexFieldDefinitionsParsing() {
        ...
        WhindexConfig expectedConfigA = WhindexConfig.builder().withValueField("xValueField").withSourceField("xSourceField").withOverloaded(true)
                        .withDestField("xDestField").withValues(Arrays.asList("xTestValue1", "xTestValue2", "xTestValue3", "xTestValue4")).build();
        ...
        WhindexConfig expectedConfigB = WhindexConfig.builder().withValueField("yValueField").withSourceField("ySourceField").withOverloaded(false)
                        .withDestField("yDestField").withValues(Arrays.asList("yTestValue1", "yTestValue2", "yTestValue3", "yTestValue4")).build();
        ...
        WhindexConfig expectedConfigC = WhindexConfig.builder().withValueField("zValueField").withSourceField("zSourceField").withOverloaded(false)
                        .withDestField("zDestField").withValues(Arrays.asList("zTestValue1", "zTestValue2", "zTestValue3", "zTestValue4")).build();
