...
public class NGramTokenizationStrategyTest extends EasyMockSupport {
    ...
    public void setup() throws Exception {
        // filter = EasyMock.createMock(BloomFilter.class);
    ...
    public void testTokenize_LowMemory() throws Exception {
        ...
        // Set expectations
        EasyMock.createMock(Logger.class);
        expect(Logger.getLogger(isA(Class.class))).andReturn(this.logger).anyTimes();
        EasyMock.createMock(ResourceAvailabilityUtil.class);
    ...
    public void testTokenize_LowDiskSpace() throws Exception {
        ...
        // Set expectations
        EasyMock.createMockBuilder(Logger.class).addMockedMethod("getLogger");
        expect(Logger.getLogger(isA(Class.class))).andReturn(this.logger).anyTimes();
        EasyMock.createMockBuilder(ResourceAvailabilityUtil.class).addMockedMethod("isDiskAvailable");
    ...
    public void testTokenize_WeightedLengthPruningWithUndefinedMaxNGramCount() throws Exception {
        ...
        assertEquals(expectedNGramCount, result2);
        ...
        assertTrue((null != result3.get(fieldName)) && (result3.get(fieldName) == expectedCount), "Should NOT have pruned the n-grams tokenized for field "
                        + fieldName + " but got " + result3.get(fieldName));
    ...
    public void testTokenize_WeightedLengthPruningWithAllUnderweightValues() throws Exception {
        ...
        assertTrue((result2 > expectedNGramCount - 3) && (result2 < idealFilterSize), "Should have applied approximately " + expectedNGramCount
                        + " n-grams to the bloom filter");
    ...
    public void testTokenize_WeightedLengthPruningWithMinorityOfOverweightValues() throws Exception {
        ...
        String fieldName = ncis.lastElement().getIndexedFieldName();
        int expectedCount = BloomFilterUtil.predictNGramCount(ncis.lastElement().getIndexedFieldValue());
        assertTrue((null != result3.get(fieldName)) && (result3.get(fieldName) < expectedCount), "Should have pruned the n-grams tokenized for field "
                        + fieldName + " but got " + result3.get(fieldName));
    }
    ...
    public void testTokenize_WeightedLengthPruningWithMajorityOfOverweightValues() throws Exception {
        ...
        assertTrue((result2 > expectedNGramCount - 20) && (result2 < idealFilterSize), "Should have applied approximately " + expectedNGramCount
                        + " n-grams to the bloom filter");
