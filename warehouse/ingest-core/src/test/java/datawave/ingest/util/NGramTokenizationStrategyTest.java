...
//        filter = EasyMock.createMock(BloomFilter.class);
    ...
    public void testTokenize_WeightedLengthPruningWithUndefinedMaxNGramCount() throws Exception {
        ...
        assertTrue((null != result3.get(fieldName)) && (result3.get(fieldName) == expectedCount),
                "Should NOT have pruned the n-grams tokenized for field " + fieldName + " but got " + result3.get(fieldName));
