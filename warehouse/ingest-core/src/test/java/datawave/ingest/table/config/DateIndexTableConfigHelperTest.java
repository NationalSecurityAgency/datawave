...
public class DateIndexTableConfigHelperTest {
    ...
    private static final Logger logger = LogManager.getLogger(DateIndexTableConfigHelperTest.class);
    ...
    public void setup() {
        ...
        Logger log = LogManager.getLogger(DateIndexTableConfigHelperTest.class);
