...
public class AbstractTableConfigHelperTest {
        ...
        public void exposeAreAggregatorsConfigured() throws AssertionError, TableNotFoundException, AccumuloSecurityException, AccumuloException {
            ...
            try {
                ...
                try {
                    ...
                    Assertions.fail("AreAggregratorsConfigured failed to throw the expected exception.");

                } catch (RuntimeException re) {

                    Throwable cause = re.getCause();

                    Assertions.assertEquals(TableNotFoundException.class, cause.getClass(), "AreAggregatorsConfigured throw the expected exception, but the type of the wrapped cause exception not the expected type.");
                }
                ...
                try {
                    ...
                    Assertions.assertEquals(AccumuloException.class, cause.getClass(), "AreAggregatorsConfigured throw the expected exception, but the type of the wrapped cause exception not the expected type.");
                }
    ...
    public void testSetPropertyIfNecessary() throws AccumuloSecurityException, AccumuloException, TableNotFoundException {
        ...
        try {
            ...
            Assertions.assertEquals(propertySize, tableProperties.size(), "AbstractTableConfigHelper.setProperityIfNecessary() call to TableOperations.setProperties failed to add the new property as expected");
