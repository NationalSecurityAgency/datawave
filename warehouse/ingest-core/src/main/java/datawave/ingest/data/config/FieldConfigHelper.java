...
public class FieldConfigHelper {
     ...
     */
    public static FieldConfigHelper load(String fieldConfigFile, BaseIngestHelper baseIngestHelper) {
    ...
    public FieldConfigHelper(InputStream in, BaseIngestHelper helper) throws ParserConfigurationException, SAXException, IOException {
