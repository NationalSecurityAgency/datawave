 ...
 *
 * @param <KEYIN> the parameter type of the handler
 */
public abstract class ContentIndexingColumnBasedHandler<KEYIN> extends AbstractColumnBasedHandler<KEYIN> implements TermFrequencyIngestHelperInterface {
    ...
    private final Set<String> termTypeDisallowlist = Collections.emptySet();
     ...
     * @param nFV             the normalized field interface
     * @throws IOException          for issues related to reading the events
     ...
     * @param nci               the normalized field interface
     * @param indexField        the index field
     * @param reverseIndexField the reverse index field
     * @param reporter          the reporter
     * @throws IOException          for issues reading input
     * @throws InterruptedException if the thread is interrupted
     */
     ...
     * @param values     the event values
     * @param shardId    the shard id
     * @param nfv        the normaalized field value
     * @param offsets    the input offsets
