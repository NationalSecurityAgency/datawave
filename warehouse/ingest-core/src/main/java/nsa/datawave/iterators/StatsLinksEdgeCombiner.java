...
import static nsa.datawave.edge.util.EdgeKey.EDGE_FORMAT.STATS;
import static nsa.datawave.edge.util.EdgeKey.STATS_TYPE.LINKS;
...
import nsa.datawave.edge.util.ExtendedHyperLogLogPlus;
