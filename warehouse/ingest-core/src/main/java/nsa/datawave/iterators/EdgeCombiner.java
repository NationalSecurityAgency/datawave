...
import nsa.datawave.edge.util.EdgeKeyDecoder;
 ...
 * 
 * Note: the {@link nsa.datawave.edge.util.EdgeValueHelper} class correctly combines old style varint array values with new style protocol buffer values. This
 * will always write protocol buffers as the value
 * 
 */
