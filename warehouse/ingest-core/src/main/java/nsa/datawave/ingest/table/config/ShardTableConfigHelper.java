package nsa.datawave.ingest.table.config;
...
import nsa.datawave.ingest.table.aggregator.CombinerConfiguration;
import nsa.datawave.ingest.table.bloomfilter.ShardIndexKeyFunctor;
...
public class ShardTableConfigHelper extends AbstractTableConfigHelper {
    ...
    protected static final String SHARDED_TABLET_BALANCER_CLASS = "nsa.datawave.ingest.table.balancer.ShardedTableTabletBalancer";
    protected static final String SHARD_KEY_FUNCTOR_CLASS = "nsa.datawave.ingest.table.bloomfilter.ShardKeyFunctor";
    ...
    protected void configureShardTable(TableOperations tops) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
        ...
        CombinerConfiguration tfConf = new CombinerConfiguration(new Column("tf"), new IteratorSetting(10, "TF",
                        nsa.datawave.ingest.table.aggregator.TextIndexAggregator.class.getName()));
    ...
    protected void configureGidxTable(TableOperations tops) throws AccumuloException, AccumuloSecurityException, TableNotFoundException {
        ...
        for (IteratorScope scope : IteratorScope.values()) {
            ...
            setPropertyIfNecessary(tableName, stem, "19,nsa.datawave.iterators.TotalAggregatingIterator", tops, log);
            stem += ".opt.";
            setPropertyIfNecessary(tableName, stem + "*", "nsa.datawave.ingest.table.aggregator.GlobalIndexUidAggregator", tops, log);
