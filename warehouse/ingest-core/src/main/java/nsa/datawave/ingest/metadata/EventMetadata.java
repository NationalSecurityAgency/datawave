...
import nsa.datawave.ingest.data.config.ingest.CompositeIngestHelperInterface;
...
public class EventMetadata implements RawRecordMetadata {
    ...
    protected void update(List<nsa.datawave.data.type.Type<?>> types, RawRecordContainer event, Collection<NormalizedContentInterface> norms,
        ...
        for (NormalizedContentInterface norm : norms) {
            for (nsa.datawave.data.type.Type<?> type : types) {
