...
import nsa.datawave.ingest.mapreduce.handler.edge.EdgeKeyVersioningCache;
...
public class GenerateEdgeKeyVersionCache {
    ...
    private static void printUsageAndExit() {
        System.out.println("Usage: nsa.datawave.ingest.util.GenerateEdgeKeyVersionCache [-init -version <integer>] [-update <cache dir>] [-addDataTypeMarkers <comma delim data types>] [<username> <password> <tableName> [<instanceName> <zookeepers>]]");
        System.exit(-1);
    }
