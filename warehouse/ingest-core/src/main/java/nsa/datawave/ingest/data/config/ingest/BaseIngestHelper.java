...
import nsa.datawave.data.type.OneToManyNormalizerType;
...
import nsa.datawave.ingest.data.config.FieldConfigHelper;
...
public abstract class BaseIngestHelper extends AbstractIngestHelper implements CompositeIngest, VirtualIngest {
    ...
    private Multimap<String,nsa.datawave.data.type.Type<?>> typeFieldMap = null;
    private Multimap<String,nsa.datawave.data.type.Type<?>> typePatternMap = null;
    private Multimap<Matcher,nsa.datawave.data.type.Type<?>> typeCompiledPatternMap = null;
    ...
    private void compilePatterns() {
        Multimap<Matcher,nsa.datawave.data.type.Type<?>> patterns = HashMultimap.create();
    ...
    @Override
    public List<nsa.datawave.data.type.Type<?>> getDataTypes(String fieldName) {
        
        final String typeFieldName = fieldName.toUpperCase();
        
        LinkedList<nsa.datawave.data.type.Type<?>> types = new LinkedList<>(typeFieldMap.get(typeFieldName));
    ...
    protected Set<String> normalizeFieldValue(String fieldName, String fieldValue) throws NormalizationException {
        Collection<nsa.datawave.data.type.Type<?>> dataTypes = getDataTypes(fieldName);
        HashSet<String> values = new HashSet<>(dataTypes.size());
        for (nsa.datawave.data.type.Type<?> dataType : dataTypes) {
    ...
    protected NormalizedContentInterface normalize(NormalizedContentInterface normalizedContent, nsa.datawave.data.type.Type<?> datawaveType) {
        // copy it
    ...
    protected List<NormalizedContentInterface> normalize(NormalizedContentInterface normalizedContent,
                    nsa.datawave.data.type.OneToManyNormalizerType<?> datawaveType) {
    ...
    protected NormalizedContentInterface normalizeFieldValue(NormalizedContentInterface normalizedContent, nsa.datawave.data.type.Type<?> datawaveType) {
        // copy it
        NormalizedContentInterface copy = new NormalizedFieldAndValue(normalizedContent);
        try {
    ...
    protected Set<NormalizedContentInterface> normalize(NormalizedContentInterface normalizedContent) {
        ...
        if (this.isIndexedField(eventFieldName) || this.isIndexedField(indexedFieldName)) {
            ...
            Collection<nsa.datawave.data.type.Type<?>> dataTypes = getDataTypes(normalizedContent.getIndexedFieldName());
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.IngestHelperInterface#addIndexedField (java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.IngestHelperInterface# addReverseIndexedField(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.IngestHelperInterface# addNormalizedField(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.IngestHelperInterface# shouldHaveBeenIndexed(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.IngestHelperInterface# shouldHaveBeenReverseIndexed(java.lang.String)
     */
    @Override
    ...
    public void updateDatawaveTypes(String fieldName, String typeClasses) {
        ...
        for (String typeClass : Splitter.on(',').split(typeClasses)) {
            ...
            nsa.datawave.data.type.Type<?> datawaveType = nsa.datawave.data.type.Type.Factory.createType(typeClass);
