...
public class SimpleAnnotationInputFormat extends SequenceFileInputFormat<LongWritable,RawRecordContainer> {
    @Override
    ...
    public RecordReader<LongWritable,RawRecordContainer> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException {
        return new RecordReader<LongWritable,RawRecordContainer>() {
            ...
            private SimpleAnnotationRecordReader delegate = null;

            @Override
            public void initialize(InputSplit split, TaskAttemptContext context) throws IOException, InterruptedException {
                delegate = new SimpleAnnotationRecordReader();
