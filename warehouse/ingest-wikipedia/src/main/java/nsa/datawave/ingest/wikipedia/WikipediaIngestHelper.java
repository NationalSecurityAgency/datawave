...
public class WikipediaIngestHelper extends BaseIngestHelper implements TermFrequencyIngestHelperInterface, IndexOnlyIngestHelperInterface {
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.AbstractIngestHelper#getEventFields(nsa.datawave.ingest.data.Event)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.data.config.ingest.IndexOnlyIngestHelperInterface#getIndexOnlyFields()
     */
    @Override
