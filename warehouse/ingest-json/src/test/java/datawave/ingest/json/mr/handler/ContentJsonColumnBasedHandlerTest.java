...
public class ContentJsonColumnBasedHandlerTest {
    ...
    public void testJsonContentHandlers() throws Exception {
        ...
        // Lucene upgrade from 4.x to 7.x changed tokenizer behavior wrt apostrophes, increasing shard and shardIndex keys generated by this test
        ColumnBasedHandlerTestUtil.processEvent(jsonHandler, edgeHandler, event, 237, 93, 4, 38, PRINT_GENERATED_KEYS_ONLY_ON_FAIL);
