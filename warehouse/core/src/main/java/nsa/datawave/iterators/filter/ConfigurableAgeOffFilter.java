...
import nsa.datawave.ingest.util.cache.ReloadableCacheBuilder;
import nsa.datawave.ingest.util.cache.watch.FileRuleWatcher;
 ...
 *      &lt;rule&gt;
 *          &lt;filterClass&gt;
 *          nsa.datawave.iterators.filter.ColumnQualifierRegexFilter
 *          &lt;/filterClass&gt;
 *          &lt;ttl units="ms"&gt;
 *          30000
 *          &lt;/ttl&gt;
