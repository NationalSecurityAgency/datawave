...
public abstract class AppliedRule implements FilterRule {
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.iterators.filter.ageoff.FilterRule#init(nsa.datawave.iterators.filter.ageoff.FilterOptions)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.iterators.filter.ageoff.FilterRule#accept(nsa.datawave.iterators.filter.ageoff.AgeOffPeriod, org.apache.accumulo.core.data.Key,
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.iterators.filter.ageoff.FilterRule#deepCopy(nsa.datawave.iterators.filter.ageoff.AgeOffPeriod)
     */
    @Override
