package nsa.datawave.ingest.util.cache;

import java.util.concurrent.Executors;

import nsa.datawave.ingest.util.cache.watch.Reloadable;
...
public class ReloadableCacheBuilder<K extends Reloadable,V> extends Loader<K,V> {
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.util.cache.Loader#merge(java.lang.Object, java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.ingest.util.cache.Loader#build(java.lang.Object)
     */
    @Override
