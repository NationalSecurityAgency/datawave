    ...
    static public ColumnVisibility simplifyColumnVisibilityForAuthorizations(ColumnVisibility columnVisibility, Collection<Authorizations> authorizations)
        ...
        if (node.getType() == NodeType.OR) {
            if (log.isTraceEnabled()) {
                log.trace("Top level OR Node, removing unsatifified branches from: " + columnVisibility.toString());
            }
            ...
            if (log.isTraceEnabled()) {
                log.trace("removed unsatifified branches, visibility now: " + simplifiedCV.toString());
            }
        }
        return simplifiedCV;
    }
