...
import static datawave.annotation.util.v1.AnnotationTestUtil.assertMetadataEqual;
import static datawave.annotation.util.v1.AnnotationTestUtil.assertSegmentsEqual;
...
public class AccumuloAnnotationSerializerTest {
    ...
    private void assertSerialization(Annotation expected, Iterator<Map.Entry<Key,Value>> results) throws InvalidProtocolBufferException {
        ...
        while (results.hasNext()) {
            ...
            assertEquals("Annotation id mismatch", "bcb2bb84", annotationId);
            if (parts.length == 2) {
