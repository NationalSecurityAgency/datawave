...
public class NYCTLCColumnBasedHandlerTest {
    ...
    public void testNyctlc01() throws Exception {
        ...
        ColumnBasedHandlerTestUtil.processEvent(abstractHandler, null, event, 58, 29, 0, 0, false);
        ...
        ColumnBasedHandlerTestUtil.processEvent(abstractHandler, null, event, 55, 23, 0, 0, false);
        ...
        ColumnBasedHandlerTestUtil.processEvent(abstractHandler, null, event, 66, 35, 0, 0, false);
