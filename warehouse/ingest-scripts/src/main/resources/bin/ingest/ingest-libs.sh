...
CLASSPATH=${CLASSPATH}:${DATAWAVE_CORE_ANNOTATION_JAR}
CLASSPATH=${CLASSPATH}:${DATAWAVE_INGEST_ANNOTATION_JAR}
...
CLASSPATH=${CLASSPATH}:${AC_ACCESS_JAR}
...
CLASSPATH=${CLASSPATH}:${NETTY_HANDLER_JAR}
CLASSPATH=${CLASSPATH}:${NETTY_COMMON_JAR}
CLASSPATH=${CLASSPATH}:${NETTY_BUFFER_JAR}
CLASSPATH=${CLASSPATH}:${NETTY_CODEC_JAR}
CLASSPATH=${CLASSPATH}:${NETTY_RESOLVER_JAR}
CLASSPATH=${CLASSPATH}:${NETTY_TRANSPORT_JAR}
CLASSPATH=${CLASSPATH}:${OPENTELEMETRY_API_JAR}
CLASSPATH=${CLASSPATH}:${OPENTELEMETRY_COMMON_JAR}
...
#for annotation
CLASSPATH=${CLASSPATH}:${PROTO_GOOGLE_COMMON_PROTOS_JAR}
CLASSPATH=${CLASSPATH}:${PROTOBUF_JAVA_UTIL_JAR}
CLASSPATH=${CLASSPATH}:${XMLRESOLVER_JAR}
CLASSPATH=${CLASSPATH}:${SAXON_HE_JAR}

#for query
CLASSPATH=${CLASSPATH}:${DATAWAVE_CORE_QUERY_JAR}
CLASSPATH=${CLASSPATH}:${DATAWAVE_CORE_TABLES_JAR}
