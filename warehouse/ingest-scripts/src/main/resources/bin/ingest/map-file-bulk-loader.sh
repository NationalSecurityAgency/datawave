...
export HADOOP_OPTS=" ${HADOOP_INGEST_OPTS} -Dlog4j2.configuration=log4j-bulkloader.xml -Dapp=bulkIngestMapFileLoader -DshutdownPort=$shutdownPort -Dfile.encoding=UTF8 -Duser.timezone=GMT"
