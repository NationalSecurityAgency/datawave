...
DATAWAVE_CORE_TABLES_JAR=$(findJar datawave-core-tables)
...
AC_ACCESS_JAR=$(findJar accumulo-access-core)
...
NETTY_HANDLER_JAR=$(findJar netty-handler)
NETTY_COMMON_JAR=$(findJar netty-common)
NETTY_BUFFER_JAR=$(findJar netty-buffer)
NETTY_CODEC_JAR=$(findJar netty-codec)
NETTY_RESOLVER_JAR=$(findJar netty-resolver)
NETTY_TRANSPORT_JAR=$(findJar netty-transport)
OPENTELEMETRY_API_JAR=$(findJar opentelemetry-api)
OPENTELEMETRY_COMMON_JAR=$(findJar opentelemetry-common)
