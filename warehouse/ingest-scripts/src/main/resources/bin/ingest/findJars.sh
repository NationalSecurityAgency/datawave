...
DATAWAVE_SERVICES_COMMON_UTIL_JAR=$(findJar datawave-services-common-util)
DATAWAVE_WS_COMMON_UTIL_JAR=$(findWebserviceJar datawave-ws-common-util)
DATAWAVE_SERVICES_COMMON_JAR=$(findJar datawave-services-common)
...
DATAWAVE_SERVICES_QUERY_JAR=$(findJar datawave-services-query)
