...
INGEST_JOB_POSTKILL_DELAY_SECS="${INGEST_JOB_POSTKILL_DELAY_SECS:-5}"
INGEST_JOB_KILL_MAX_RETRIES="${INGEST_JOB_KILL_MAX_RETRIES}"
INGEST_JOB_KILL_MAX_RETRIES="${INGEST_JOB_KILL_MAX_RETRIES:-5}"
INGEST_JOB_KILL_LOOP_DELAY_SECS="${INGEST_JOB_KILL_LOOP_DELAY_SECS}"
INGEST_JOB_KILL_LOOP_DELAY_SECS="${INGEST_JOB_KILL_LOOP_DELAY_SECS:-60}"
