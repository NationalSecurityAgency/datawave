...
ANNOTATION_TABLE_NAME="${table.name.annotation}"
ANNOTATION_TABLE_NAME="${ANNOTATION_TABLE_NAME:-annotation}"
ANNOTATION_SOURCE_TABLE_NAME="${table.name.annotation.source}"
ANNOTATION_SOURCE_TABLE_NAME="${ANNOTATION_SOURCE_TABLE_NAME:-annotationSource}"
