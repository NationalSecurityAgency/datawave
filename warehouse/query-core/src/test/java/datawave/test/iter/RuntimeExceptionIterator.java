 ...
 */
public class RuntimeExceptionIterator implements SortedKeyValueIterator<Key,Value>, OptionDescriber {
    ...
    public boolean validateOptions(Map<String,String> map) {
        ...
        if (option == null) {
            ...
            try {
                ...
                exceptionClazz = (Class<? extends RuntimeException>) Class.forName(option);
    ...
    private void fireException() {
        try {
            Constructor<? extends RuntimeException> constructor = exceptionClazz.getConstructor(String.class);
