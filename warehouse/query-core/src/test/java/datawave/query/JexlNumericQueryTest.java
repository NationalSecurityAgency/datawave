...
public class JexlNumericQueryTest extends AbstractFunctionalQuery {
    ...
    public void testLteGteBound() throws Exception {
        ...
        String query = "((BR = true) && (" + CityField.NUM.name() + LTE_OP + "20 " + AND_OP + CityField.NUM.name() + GTE_OP + "20))";
        runTest(query, query);
    }
    ...
    public void testGteLteBound() throws Exception {
        ...
        String query = "((BR = true) && (" + CityField.NUM.name() + GTE_OP + "20 " + AND_OP + CityField.NUM.name() + LTE_OP + "40))";
        runTest(query, query);
    }
    ...
    public void testGtLtBound() throws Exception {
        ...
        String query = "((BR = true) && (" + CityField.NUM.name() + GT_OP + "24 " + AND_OP + CityField.NUM.name() + LT_OP + "105))";
        runTest(query, query);
    }
    ...
    public void testMultiBound() throws Exception {
        ...
        String query = "((BR = true) && (" + CityField.NUM.name() + GT_OP + "15 " + AND_OP + CityField.NUM.name() + LT_OP + "24))" + OR_OP
                        + "((BR = true) && (" + CityField.NUM.name() + GT_OP + "31 and " + CityField.NUM.name() + LT_OP + "42))";
        runTest(query, query);
    }
    ...
    public void testAndGteLte() throws Exception {
        ...
        for (final TestCities city : TestCities.values()) {
            String query = "((BR = true) && (" + CityField.NUM.name() + GTE_OP + "100 " + AND_OP + CityField.NUM.name() + LTE_OP + "130 " + ")) and "
