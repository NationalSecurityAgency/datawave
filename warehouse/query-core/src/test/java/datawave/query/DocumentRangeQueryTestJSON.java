 ...
 */
public class DocumentRangeQueryTestJSON extends AbstractDocumentQueryTest {

    @ClassRule
    public static AccumuloSetup accumuloSetup = new AccumuloSetup();

    private static final Logger log = Logger.getLogger(DocumentRangeQueryTestJSON.class);
    ...
    public DocumentRangeQueryTestJSON() {
    ...
    public void testErrorRangeOpsInDiffSubTree() throws Exception {
        ...
        String query = CityField.NUM.name() + LTE_OP + "100" + AND_OP + "(" + CityField.CITY.name() + EQ_OP + "'" + city + "'" + OR_OP + CityField.NUM.name()
                        + GTE_OP + "100)";
        ((DocumentQueryPlanner) logic.getQueryPlanner()).setExecutableExpansion(false);
