...
public class CoreVisitorTests {
     ...
     *
     * <p>
     * List of test cases using {@code assertValid} and {@code assertInvalid} statements that cover all possible forms of queries according to the modified
     * Lucene syntax:
     * </p>
     *
     * <p>
     ...
     * <li><strong>Edge Cases:</strong> Covers ambiguous cases and ensures they are properly flagged as invalid. For example, multiple {@code NOT} operators
     * without parentheses can lead to ambiguity.</li>
     ...
     *
     * <p>
     * These test cases cover a wide range of possible query forms, ensuring that both valid and invalid (ambiguous) queries are properly identified according
     * to the provided syntax guidelines.
     * </p>
     */
