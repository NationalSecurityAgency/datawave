...
public class FilterFunctionQueryTest extends UseSequentialScheduler {
    ...
    public void testIncludeRegex() throws Exception {
        ...
        for (final TestCities city : TestCities.values()) {
            String query = CityField.CITY.name() + EQ_OP + "'" + city.name() + "'" + AND_OP + IncludeRegex + CityField.STATE.name() + "," + state + ")";
    ...
    public void testIncludeRegexWithNumeric() throws Exception {
        ...
        for (final TestCities city : TestCities.values()) {
            String query = CityField.CITY.name() + EQ_OP + "'" + city.name() + "'" + AND_OP + IncludeRegex + CityField.STATE.name() + "||"
