...
public class DocumentGroupsQueryTest extends AbstractDocumentQueryTest {

    @ClassRule
    public static AccumuloSetup accumuloSetup = new AccumuloSetup();

    private static final Logger log = Logger.getLogger(DocumentGroupsQueryTest.class);
    ...
    public DocumentGroupsQueryTest() {
