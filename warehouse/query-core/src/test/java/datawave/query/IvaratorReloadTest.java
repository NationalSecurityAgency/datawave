...
public class IvaratorReloadTest {
    ...
    /**
     * Basically create an ivarator, seek it and verify it persisted.  Then create a second ivarator
     * against the same directory, and verify it reused the same files by verifying the files were
    ...
    public void reloadTest() throws Exception {
        ...
        Range range2 = new Range(new Key("20000105_0", "MixedGeo\0-2xav59.x0c0q3.-yac0vs", "POINT\0POINT (2 3)"), false, new Key("20000105_0" + Constants.MAX_UNICODE_STRING), false);
    ...
    private class IvaratorDirState {
        ...
        public boolean equals(Object other) {
            if (other instanceof IvaratorDirState) {
                ...
                EqualsBuilder builder = new EqualsBuilder()
                        .append(complete, state.complete)
                        .append(sortedSetBytes, state.sortedSetBytes)
        ...
        public String toString() {
            ...
            builder.append("complete: ").append(complete)
                    .append(", ").append("dates: ").append(sortedSetDates)
                    .append(", ").append("bytes: ").append(sortedSetBytes);
