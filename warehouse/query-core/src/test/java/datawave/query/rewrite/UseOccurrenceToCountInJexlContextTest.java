...
import static datawave.query.rewrite.QueryTestTableHelper.SHARD_RINDEX_TABLE_NAME;
...
public abstract class UseOccurrenceToCountInJexlContextTest {
    ...
    public void setup() throws Exception {
        ...
        logic.setModelTableName(METADATA_TABLE_NAME);
    ...
    private static class MoreTestData {
        ...
        public static void writeItAll(Connector con, WhatKindaRange range) throws Exception {
            ...
            try {
                ...
                bw = con.createBatchWriter(METADATA_TABLE_NAME, bwConfig);
