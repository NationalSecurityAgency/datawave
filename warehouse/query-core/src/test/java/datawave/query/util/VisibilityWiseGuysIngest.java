...
public class VisibilityWiseGuysIngest {
    ...
    public static void writeItAll(Connector con, WhatKindaRange range) throws Exception {
        ...
        try {
            ...
            mutation.put(datatype + "\u0000" + corleoneUID, "MAGIC.0" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "UUID.0" + "\u0000" + "CORLEONE", columnVisibilityEnglish, timeStamp, emptyValue);
            // CORLEONE date delta is 70 years
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTH_DATE" + "\u0000" + "1930-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "DEATH_DATE" + "\u0000" + "2000-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "QUOTE" + "\u0000" + "Im gonna make him an offer he cant refuse", columnVisibilityEnglish,
    ...
    private static void addTokens(BatchWriter bw, WhatKindaRange range, String field, String phrase, String uid) throws MutationsRejectedException {
        ...
        mutation.put(field.toUpperCase(), shard + "\u0000" + datatype, columnVisibilityEnglish, timeStamp,
    ...
    private static void addFiTokens(BatchWriter bw, WhatKindaRange range, String field, String phrase, String uid) throws MutationsRejectedException {
        ...
        fi.put("fi\u0000" + field.toUpperCase(), lcNoDiacriticsType.normalize(phrase) + "\u0000" + datatype + "\u0000" + uid, columnVisibilityEnglish,
                        timeStamp, emptyValue);
        
        String[] tokens = phrase.split(" ");
        for (String token : tokens) {
            fi.put("fi\u0000" + field.toUpperCase(), lcNoDiacriticsType.normalize(token) + "\u0000" + datatype + "\u0000" + uid, columnVisibilityEnglish,
                            timeStamp, emptyValue);
        }
        bw.addMutation(fi);
    }
