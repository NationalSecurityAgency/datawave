...
/**
 * This is the same as WiseGuysIngest ( at some point ) and was modified to go across days, and has ingest holes for some of the fields. Intended for testing
 * out the DatePartitionedQueryPlanner
 */
public class HoleyWiseGuysIngest {
    ...
    protected static final SimpleDateFormat shardFormat = new SimpleDateFormat("yyyyMMdd");
    ...
    protected static final long timeStamp = 1356998400000L; // 20130101T00:00:00 GMT
    protected static final long MILLIS_PER_DAY = 1000L * 60 * 60 * 24;
    ...
    public static final long sopranoTimeStampDelta = 1 * MILLIS_PER_DAY + 10;
    public static final String caponeUID = UID.builder().newId("Capone".getBytes(), (Date) null).toString();
    public static final long caponeTimeStampDelta = 2 * MILLIS_PER_DAY + 20;
    public static final String tattagliaUID = UID.builder().newId("Tattaglia".getBytes(), (Date) null).toString();

    public static final String corleoneDate = shardFormat.format(new Date(timeStamp + corleoneTimeStampDelta));
    public static final String sopranoDate = shardFormat.format(new Date(timeStamp + sopranoTimeStampDelta));
    public static final String caponeDate = shardFormat.format(new Date(timeStamp + caponeTimeStampDelta));
    public static final String tattagliaDate = shardFormat.format(new Date(timeStamp));
    public static final String SHARD_ZERO = "_0";
    public static final String corleoneShard = corleoneDate + SHARD_ZERO;
    public static final String sopranoShard = sopranoDate + SHARD_ZERO;
    public static final String caponeShard = caponeDate + SHARD_ZERO;
    public static final String tattagliaShard = tattagliaDate + SHARD_ZERO;
    ...
    public static void writeItAll(AccumuloClient client, WhatKindaRange range) throws Exception {
        ...
        try {
            ...
            mutation = new Mutation(corleoneShard);
            ...
            mutation = new Mutation(sopranoShard);
            ...
            mutation = new Mutation(caponeShard);
            ...
            mutation = new Mutation(tattagliaShard);
        ...
        try {
            ...
            mutation.put("UUID".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
            ...
            mutation.put("NOME".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            ...
            mutation.put("GENDER".toUpperCase(), sopranoShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
            mutation.put("GENDER".toUpperCase(), caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            mutation.put("GENERE".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            ...
            mutation.put("ETA".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            ...
            mutation.put("AGE".toUpperCase(), caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            mutation.put("ETA".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            mutation = new Mutation(numberType.normalize("18"));
            mutation.put("AGE".toUpperCase(), sopranoShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
            mutation.put("ETA".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            ...
            for (String normalized : ((OneToManyNormalizerType<Geometry>) geoType).normalizeToMany("POINT(10 10)")) {
                ...
                mutation.put("GEO".toUpperCase(), corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                                range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
                bw.addMutation(mutation);
            }
            ...
            mutation.put("UUID".toUpperCase(), sopranoShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
            bw.addMutation(mutation);
            // names
            mutation = new Mutation(lcNoDiacriticsType.normalize("ANTHONY"));
            mutation.put("NAME".toUpperCase(), sopranoShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
            bw.addMutation(mutation);
            ...
            for (String normalized : ((OneToManyNormalizerType<Geometry>) geoType).normalizeToMany("POINT(20 20)")) {
                mutation = new Mutation(normalized);
                mutation.put("GEO".toUpperCase(), sopranoShard + "\u0000" + datatype, columnVisibility, timeStamp,
                                range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
                bw.addMutation(mutation);
            }
            ...
            mutation.put("UUID".toUpperCase(), caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            bw.addMutation(mutation);
            // names
            mutation = new Mutation(lcNoDiacriticsType.normalize("ALPHONSE"));
            mutation.put("NAME".toUpperCase(), caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            bw.addMutation(mutation);
            ...
            for (String normalized : ((OneToManyNormalizerType<Geometry>) geoType).normalizeToMany("POINT(30 30)")) {
                mutation = new Mutation(normalized);
                mutation.put("GEO".toUpperCase(), caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                                range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
                bw.addMutation(mutation);
            }
            ...
            mutation.put("UUID".toUpperCase(), tattagliaShard + "\u0000" + secondDataType, columnVisibility, timeStamp,
            ...
            mutation.put("NAME".toUpperCase(), tattagliaShard + "\u0000" + secondDataType, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(tattagliaUID));
            bw.addMutation(mutation);
            // ages
            mutation = new Mutation(numberType.normalize("70"));
            mutation.put("AGE".toUpperCase(), tattagliaShard + "\u0000" + secondDataType, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(tattagliaUID));
            bw.addMutation(mutation);

            // add some index-only fields
            mutation = new Mutation("chicago");
            mutation.put("LOCATION", caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            bw.addMutation(mutation);
            mutation = new Mutation("newyork");
            mutation.put("POSIZIONE", corleoneShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            mutation = new Mutation("newjersey");
            mutation.put("LOCATION", sopranoShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
            bw.addMutation(mutation);
            mutation = new Mutation("11y");
            mutation.put("SENTENCE", caponeShard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            bw.addMutation(mutation);
        ...
        try {
            ...
            bw.addMutation(mutation);
            mutation = new Mutation(new StringBuilder(lcNoDiacriticsType.normalize("MALE")).reverse());
            mutation.put("GENDER".toUpperCase(), tattagliaShard + "\u0000" + secondDataType, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(tattagliaUID));
            bw.addMutation(mutation);
            // ages
        ...
        try {
            ...
            addDColumn(datatype, corleoneUID, "CONTENT", "Im gonna make him an offer he cant refuse", bw, corleoneTimeStampDelta);
            addDColumn(datatype, sopranoUID, "CONTENT", "If you can quote the rules then you can obey them", bw, sopranoTimeStampDelta);
            addDColumn(datatype, caponeUID, "CONTENT", "You can get much farther with a kind word and a gun than you can with a kind word alone", bw,
                            caponeTimeStampDelta);
            addDColumn(datatype, caponeUID, "CONTENT2", "A lawyer and his briefcase can steal more than ten men with guns.", bw, caponeTimeStampDelta);
        } finally {
            if (null != bw) {
                bw.close();
            }
        ...
        try {
            ...
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(10L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(10L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(10L)));
            ...
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(secondDataType + "\u0000" + tattagliaDate),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(10L)));
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(19L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(19L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(19L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(11L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(11L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(11L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(secondDataType), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(secondDataType + "\u0000" + tattagliaDate),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(11L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(secondDataType), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(secondDataType), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(21L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(21L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(21L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(12L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(12L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(12L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(secondDataType), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(secondDataType + "\u0000" + tattagliaDate),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(12L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(secondDataType), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(secondDataType), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(22L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(22L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(22L)));
            mutation.put(ColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
            ...
            mutation.put(ColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + corleoneDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + sopranoDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
            mutation.put(ColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + caponeDate), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
    ...
    private static void addTokens(BatchWriter bw, WhatKindaRange range, String field, String phrase, String uid, long timeStampDelta)
        ...
        String shard = shardFormat.format(new Date(timeStamp + timeStampDelta)) + "_0";
    ...
    private static void addDColumn(String datatype, String uid, String contentName, String content, BatchWriter bw, long timeStampDelta)
        ...
        d.put("d", datatype + "\u0000" + uid + "\u0000" + contentName, columnVisibility, timeStamp + timeStampDelta, value);
        bw.addMutation(d);
    }
}
