...
public class WiseGuysIngest {
    ...
    public static void writeItAll(AccumuloClient client, WhatKindaRange range) throws Exception {
        ...
        try {
            ...
            mutation.put(datatype + "\u0000" + corleoneUID, "BAIL.0" + "\u0000" + "12345", columnVisibility, timeStamp + corleoneTimeStampDelta, emptyValue);
            ...
            mutation.put(datatype + "\u0000" + sopranoUID, "BAIL.0" + "\u0000" + "123401", columnVisibility, timeStamp + sopranoTimeStampDelta, emptyValue);
        ...
        try {
            ...
            mutation.put("BAIL".toUpperCase(), shard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(corleoneUID));
            bw.addMutation(mutation);
            mutation = new Mutation(numberType.normalize("123401"));
            mutation.put("BAIL".toUpperCase(), shard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(sopranoUID));
            bw.addMutation(mutation);
            ...
            mutation.put("SENTENCE", shard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            bw.addMutation(mutation);
            mutation = new Mutation("+dE4.015");
            mutation.put("SENTENCE_DAYS", shard + "\u0000" + datatype, columnVisibility, timeStamp,
                            range == WhatKindaRange.SHARD ? getValueForNuthinAndYourHitsForFree() : getValueForBuilderFor(caponeUID));
            bw.addMutation(mutation);
        ...
        try {
            ...
            mutation.put("fi\u0000" + "SENTENCE", "11y" + "\u0000" + datatype + "\u0000" + caponeUID, columnVisibility, timeStamp + caponeTimeStampDelta,
                            emptyValue);
            mutation.put("fi\u0000" + "SENTENCE_DAYS", "+dE4.015" + "\u0000" + datatype + "\u0000" + caponeUID, columnVisibility,
                            timeStamp + caponeTimeStampDelta, emptyValue);
        ...
        try {
            ...
            mutation = new Mutation("NAME");
            mutation.put(MetadataColumnFamilyConstants.COLF_E, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(secondDataType + "\u0000" + date),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(10L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(secondDataType + "\u0000" + normalizerForColumn("NAME")), emptyValue);
            bw.addMutation(mutation);
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(secondDataType + "\u0000" + normalizerForColumn("GENDER")), emptyValue);
            bw.addMutation(mutation);
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(secondDataType + "\u0000" + normalizerForColumn("AGE")), emptyValue);
            bw.addMutation(mutation);

            mutation = new Mutation("BAIL");
            mutation.put(MetadataColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + date), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(12L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);

            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(datatype + "\u0000" + normalizerForColumn("BAIL")), emptyValue);
            bw.addMutation(mutation);
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(datatype + "\u0000" + normalizerForColumn("GEO")), emptyValue);
            bw.addMutation(mutation);
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + date), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(12L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(datatype + "\u0000" + normalizerForColumn("NUMBER")), emptyValue);
            bw.addMutation(mutation);
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + "20210103"),
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_E, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + "20121231"),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + "20130101"),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + "20130102"),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + "20210103"),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(30L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + "20210104"),
                            new Value(SummingCombiner.VAR_LEN_ENCODER.encode(30L)));

            // just indexed 20121231
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(datatype), 1356988400000L, emptyValue);
            bw.addMutation(mutation);
            ...
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(secondDataType), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_T, new Text(secondDataType + "\u0000" + normalizerForColumn("UUID")), emptyValue);
            bw.addMutation(mutation);
            ...
            bw.addMutation(mutation);
            mutation = new Mutation("SENTENCE_DAYS");
            mutation.put(MetadataColumnFamilyConstants.COLF_F, new Text(datatype + "\u0000" + date), new Value(SummingCombiner.VAR_LEN_ENCODER.encode(3L)));
            mutation.put(MetadataColumnFamilyConstants.COLF_I, new Text(datatype), emptyValue);
            mutation.put(MetadataColumnFamilyConstants.COLF_RI, new Text(datatype), emptyValue);
