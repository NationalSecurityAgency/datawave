...
public class VisibilityWiseGuysNoGroupingIngestWithModel {
    ...
    public static void writeItAll(AccumuloClient client, WhatKindaRange range) throws Exception {
        ...
        try {
            ...
            // Specifically create entries with duplicated values for the different model mappings of GENDER,GENERE and AGE,ETA to test filtering out duplicate
            // datum points when grouping/aggregating with the query model.
            mutation.put(datatype + "\u0000" + corleoneUID, "NOME" + "\u0000" + "SANTINO", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENERE" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE" + "\u0000" + "24", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "ETA" + "\u0000" + "24", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "MAGIC" + "\u0000" + "18", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "UUID" + "\u0000" + "CORLEONE", columnVisibilityItalian, timeStamp, emptyValue);
            ...
            mutation.put(datatype + "\u0000" + sopranoUID, "GENERE.1" + "\u0000" + "FEMALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "AGE.1" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "ETA.1" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "MAGIC.1" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "UUID.1" + "\u0000" + "SOPRANO", columnVisibilityEnglish, timeStamp, emptyValue);
            // soprano date delta is 50 years
            mutation.put(datatype + "\u0000" + sopranoUID, "BIRTH_DATE.1" + "\u0000" + "1950-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "DEATH_DATE.1" + "\u0000" + "2000-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "QUOTE.1" + "\u0000" + "If you can quote the rules then you can obey them", columnVisibilityEnglish,
                            timeStamp, emptyValue);

            mutation.put(datatype + "\u0000" + caponeUID, "NAME.FOO.BAZ.1" + "\u0000" + "MICHAEL", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENDER.FOO.BAZ.1" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENERE.FOO.BAZ.1" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "AGE.FOO.BAZ.1" + "\u0000" + "40", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "ETA.FOO.BAZ.1" + "\u0000" + "40", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "MAGIC.FOO.BAZ.1" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "UUID.FOO.BAZ.1" + "\u0000" + "CAPONE", columnVisibilityEnglish, timeStamp, emptyValue);

            // capone date delta is 89 or 90 years
            mutation.put(datatype + "\u0000" + caponeUID, "BIRTH_DATE.FOO.BAZ.1" + "\u0000" + "1910-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            // add a second date to test function taking an Iterable
            mutation.put(datatype + "\u0000" + caponeUID, "BIRTH_DATE.FOO.BAZ.1" + "\u0000" + "1911-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "DEATH_DATE.FOO.BAZ.1" + "\u0000" + "2000-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID,
                            "QUOTE.FOO.BAZ.1" + "\u0000" + "You can get much farther with a kind word and a gun than you can with a kind word alone",
