...
public class VisibilityWiseGuysNoGroupingIngestWithModel {
    ...
    public static void writeItAll(AccumuloClient client, WhatKindaRange range) throws Exception {
        ...
        try {
            ...
            mutation.put(datatype + "\u0000" + sopranoUID, "NAME" + "\u0000" + "MEADOW", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "GENDER" + "\u0000" + "FEMALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "AGE" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "MAGIC" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "UUID" + "\u0000" + "SOPRANO", columnVisibilityEnglish, timeStamp, emptyValue);
            ...
            mutation.put(datatype + "\u0000" + caponeUID, "NAME" + "\u0000" + "MICHAEL", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENDER" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "AGE" + "\u0000" + "40", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "MAGIC" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "UUID" + "\u0000" + "CAPONE", columnVisibilityEnglish, timeStamp, emptyValue);

            // capone date delta is 89 or 90 years
            mutation.put(datatype + "\u0000" + caponeUID, "BIRTH_DATE" + "\u0000" + "1910-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            // add a second date to test function taking an Iterable
            mutation.put(datatype + "\u0000" + caponeUID, "BIRTH_DATE" + "\u0000" + "1911-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "DEATH_DATE" + "\u0000" + "2000-12-28T00:00:05.000Z", columnVisibilityEnglish, timeStamp,
                            emptyValue);
