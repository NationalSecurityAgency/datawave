...
public class IndexMatchingIteratorTest {
    ...
    public static void setUp() {
        ...
        terms = Sets.newHashSet(Pair.with("firetruck", "vehicle"),
                Pair.with("ruddy duck", "bird"),
                Pair.with("ruddy duck", "unidentified flying object"),
                Pair.with("motorcycle", "vehicle"),
                Pair.with("motorboat", "vehicle"),
                Pair.with("strike", "actionable offense"),
                Pair.with("car", "vehicle"),
                Pair.with("trophy", "prize"),
                Pair.with("police officer", "otherperson"),
                Pair.with("skydiver", "occupation"),
                Pair.with("bbc", "network"),
                Pair.with("onyx", "pokemon"),
                Pair.with("onyx", "rock"),
                Pair.with("onyx", "rooster"),
                Pair.with("rooster", "cockadoodledoo"));
        ...
        terms = Sets.newHashSet(
                ...
                Pair.with("skydiver", "occupation"),
                Pair.with("skydiver", "occupation"),
                Pair.with("xxx.skydiver", "occupation"),
                Pair.with("xxx.skydiver", "occupation"),
                Pair.with("xxx.skydiver", "occupation"),
                Pair.with("xxx.skydiver", "occupation"),
                Pair.with("xxx.skydiver", "occupation"),
                Pair.with("yyy.skydiver", "occupation"),
                Pair.with("yyy.skydiver", "occupation"),
                Pair.with("yyy.skydiver", "occupation"),
    ...
    public void testMix() throws Throwable {
        ...
        assertEquals(ImmutableSet.of(Pair.with("onyx", "rock"),
                Pair.with("ruddy duck", "bird"),
                Pair.with("firetruck", "vehicle"),
                Pair.with("motorboat", "vehicle"),
                Pair.with("motorcycle", "vehicle"),
                Pair.with("skydiver", "occupation"),
    ...
    public void testReverse() throws Throwable {
        ...
        assertEquals(ImmutableSet.of(
                Pair.with("xxx.skydiver", "occupation"),
                Pair.with("yyy.skydiver", "occupation")), matches);
    }
