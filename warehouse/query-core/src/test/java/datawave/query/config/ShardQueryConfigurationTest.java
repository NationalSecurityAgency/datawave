...
public class ShardQueryConfigurationTest {
    ...
    public void testEmptyConstructor() {
        ...
        Assert.assertEquals(TableNames.SHARD_TABLE_NAME, config.getShardTableName());
        Assert.assertEquals(TableNames.SHARD_INDEX_TABLE_NAME, config.getIndexTableName());
        Assert.assertEquals(TableNames.SHARD_RINDEX_TABLE_NAME, config.getReverseIndexTableName());
        Assert.assertEquals(TableNames.METADATA_TABLE_NAME, config.getMetadataTableName());
        Assert.assertEquals(TableNames.DATE_INDEX_TABLE_NAME, config.getDateIndexTableName());
        Assert.assertEquals(TableNames.INDEX_STATS_TABLE_NAME, config.getIndexStatsTableName());
        ...
        Assert.assertEquals(TableNames.METADATA_TABLE_NAME, config.getModelTableName());
