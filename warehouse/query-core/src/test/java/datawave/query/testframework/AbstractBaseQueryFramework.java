 ...
 * </ul>
 */
public abstract class AbstractBaseQueryFramework<L extends ShardedBaseQueryLogic> implements QueryLogicTestHarness.TestResultParser {
    ...
    private static final Logger log = Logger.getLogger(AbstractBaseQueryFramework.class);
    ...
    protected AbstractBaseQueryFramework(final RawDataManager mgr) {
        this.dataManager = mgr;
    }
    
    protected abstract L createQueryLogic();

    protected QueryPlanner createQueryPlanner(){
        return new DefaultQueryPlanner();
    }
    ...
    public void querySetUp() throws IOException {
        ...
        this.logic.setQueryPlanner(createQueryPlanner());
    ...
    protected void runTestQuery(Collection<String> expected, String queryStr, Date startDate, Date endDate, Map<String,String> options,
        ...
        if (this.logic instanceof DocumentLogic) {
            testHarness.assertLogicResults((DocumentLogic) this.logic, expected, checkers);
        }else{
            testHarness.assertLogicResults((ShardQueryLogic) this.logic, expected, checkers);
        }
