...
class IncludeExcludeIndexFieldsRuleTest extends ShardQueryRuleTest {
    ...
    void testFunctionWithSingleIndexedField(String name) throws Exception {
        ...
        expectMessage("Index Only fields found within the function filter:" + name + ": INDEXED1");
    ...
    void testMultipleFunctionWithIndexedField() throws Exception {
        ...
        expectMessage("Index Only fields found within the function filter:includeRegex: INDEXED1");
        expectMessage("Index Only fields found within the function filter:excludeRegex: INDEXED2");
