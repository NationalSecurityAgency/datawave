...
public class DocumentMiscQueryTest extends AbstractDocumentQueryTest {

    @ClassRule
    public static AccumuloSetup accumuloSetup = new AccumuloSetup();

    private static final Logger log = Logger.getLogger(DocumentMiscQueryTest.class);
