...
public class UniqueGranularityTest {
    ...
    public void testTenthMinuteTruncation() {
        assertEquals("TENTH", UniqueGranularity.TRUNCATE_TEMPORAL_TO_MINUTE_TEN.getName());
        assertNull(UniqueGranularity.TRUNCATE_TEMPORAL_TO_MINUTE_TEN.transform(null));
        assertEquals("nonDateValue", UniqueGranularity.TRUNCATE_TEMPORAL_TO_MINUTE_TEN.transform("nonDateValue"));
        assertEquals("3", UniqueGranularity.TRUNCATE_TEMPORAL_TO_MINUTE_TEN.transform("2019-01-15 12:30:15"));
        assertEquals("1", UniqueGranularity.TRUNCATE_TEMPORAL_TO_MINUTE_TEN.transform("2019-01-15 3:10:15"));
    }
