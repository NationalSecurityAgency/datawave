...
public class GeoFeatureVisitorTest {
    ...
    public void testGeoQueryOnly() throws Exception {
        ...
        assertTrue(geoFeatures.contains(new QueryGeometry("geowave:intersects(GEO_FIELD, 'POLYGON((10 10, -10 10, -10 -10, 10 -10, 10 10 ))')", "{\"type\":\"Polygon\",\"coordinates\":[[[10,10],[-10,10],[-10,-10],[10,-10],[10,10]]]}")));
    }
    ...
    public void testGeomQueryOnly() throws Exception {
        ...
        assertEquals(1, geoFeatures.size());
        assertTrue(geoFeatures.contains(new QueryGeometry("geowave:intersects(GEOM_FIELD, 'POLYGON((-90 -90, 90 -90, 90 90, -90 90, -90 -90))')", "{\"type\":\"Polygon\",\"coordinates\":[[[-90,-90],[90,-90],[90,90],[-90,90],[-90,-90]]]}")));
    }
