...
public class DatawaveInterpreterTest {
    ...
    public void testAssignments() {
        // test plain assignment to true will return true
        String assignmentTrue = "(_value_ = true)";
        String query = assignmentTrue;
        test(query, true);

        // test plain assignment to false will return false
        String assignmentFalse = "(_value_ = false)";
        query = assignmentFalse;
        test(query, false);
