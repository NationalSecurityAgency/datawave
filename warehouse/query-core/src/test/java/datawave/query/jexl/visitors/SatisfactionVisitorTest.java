...
public class SatisfactionVisitorTest {
    ...
    String[] originalQueries = {"MAKE == 'Ford' && COLOR == 'red' && OWNER != null", "MAKE == 'Ford' && COLOR == 'red' && OWNER == null",
            ...
            "MAKE == 'Ford' && EXCLUDEME == 'foo'", "((EVTM = true) && (FOO_USER >= '09021f44' && FOO_USER <= '09021f47'))",
            "((EOTM = true) && (FOO_USER >= '09021f44' && FOO_USER <= '09021f47'))", "FOO_USER >= '09021f44' && FOO_USER <= '09021f47'",
            "(MAKE == null || ((DP = true) && (MAKE == '020')) || MAKE == null)"};
