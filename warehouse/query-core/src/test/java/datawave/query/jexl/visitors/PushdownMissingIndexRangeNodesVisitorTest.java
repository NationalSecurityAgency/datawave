...
public class PushdownMissingIndexRangeNodesVisitorTest {
    ...
    public void testDelayEquality1() throws Exception {
        ...
        List<IndexValueGap> holes = new ArrayList<>();
        holes.add(new IndexValueGap(new String[] {"20100101", "20100102"}, new String[] {"ca1", "ca2"}));
        config.setIndexValueGaps(holes);
    ...
    public void testDelayEquality5() throws Exception {
        ASTJexlScript script = JexlASTHelper.parseJexlQuery("FOO == 'jsub' && (FOO == 'ca1' || UNINDEXED == 'ca1')");
        List<IndexValueGap> holes = new ArrayList<>();
        holes.add(new IndexValueGap(new String[] {"20100102", "20100103"}, new String[] {"ca1", "ca2"}));
        config.setIndexValueGaps(holes);
    ...
    public void testDelayMultipleHoles() throws Exception {
        ...
        List<IndexValueGap> holes = new ArrayList<>();
        holes.add(new IndexValueGap(new String[] {"20100101", "20100102"}, new String[] {"ca21", "ca3"}));
        holes.add(new IndexValueGap(new String[] {"20100101", "20100102"}, new String[] {"dab", "dac"}));
        holes.add(new IndexValueGap(new String[] {"20100101", "20100102"}, new String[] {"ca1", "ca11"}));
        holes.add(new IndexValueGap(new String[] {"20100101", "20100102"}, new String[] {"aba", "abc"}));
        holes.add(new IndexValueGap(new String[] {"20100102", "20100103"}, new String[] {"ca2", "ca21"}));
