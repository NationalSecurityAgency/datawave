...
public class GroupingFiltersIngest {
    ...
    public static void writeItAll(AccumuloClient client, Range range) throws Exception {
        ...
        try {
            ...
            mutation.put(datatype + "\u0000" + corleoneUID, "NAME.BAT.ZIP.0" + "\u0000" + "SANTINO", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "NAME.BAT.ZIP.1" + "\u0000" + "FREDO", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "NAME.WHAM.ZIP.2" + "\u0000" + "MICHAEL", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "NAME.WHAM.BAZ.3" + "\u0000" + "CONSTANZIA", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "NAME.WHAM.BAZ.4" + "\u0000" + "LUCA", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "NAME.WHAM.BAZ.5" + "\u0000" + "VINCENT", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER.BAT.ZIP.0" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER.BAT.ZIP.1" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER.WHAM.ZIP.2" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER.WHAM.BAZ.3" + "\u0000" + "FEMALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER.WHAM.BAZ.4" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "GENDER.WHAM.BAZ.5" + "\u0000" + "MALE", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE.BAT.ZIP.0" + "\u0000" + "24", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE.BAT.ZIP.1" + "\u0000" + "22", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE.WHAM.ZIP.2" + "\u0000" + "20", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE.WHAM.BAZ.3" + "\u0000" + "18", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE.WHAM.BAZ.4" + "\u0000" + "40", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "AGE.WHAM.BAZ.5" + "\u0000" + "22", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTHDAY.BAT.ZIP.0" + "\u0000" + "1", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTHDAY.BAT.ZIP.1" + "\u0000" + "2", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTHDAY.WHAM.ZIP.2" + "\u0000" + "3", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTHDAY.WHAM.BAZ.3" + "\u0000" + "4", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTHDAY.WHAM.BAZ.4" + "\u0000" + "5", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "BIRTHDAY.WHAM.BAZ.5" + "\u0000" + "22", columnVisibilityItalian, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + corleoneUID, "UUID.BAT.ZIP.0" + "\u0000" + "CORLEONE", columnVisibilityItalian, timeStamp, emptyValue);
            ...
            mutation.put(datatype + "\u0000" + sopranoUID, "NAME.BAT.ZIP.0" + "\u0000" + "ANTHONY", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "NAME.BAT.ZIP.1" + "\u0000" + "MEADOW", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "GENDER.BAT.ZIP.0" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "GENDER.BAT.ZIP.1" + "\u0000" + "FEMALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "AGE.BAT.ZIP.0" + "\u0000" + "16", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "AGE.BAT.ZIP.1" + "\u0000" + "18", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + sopranoUID, "UUID.BAT.ZIP.1" + "\u0000" + "SOPRANO", columnVisibilityEnglish, timeStamp, emptyValue);
            ...
            mutation.put(datatype + "\u0000" + caponeUID, "NAME.BAT.ZIP.0" + "\u0000" + "ALPHONSE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "NAME.BAT.ZIP.1" + "\u0000" + "FRANK", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "NAME.BAT.ZIP.2" + "\u0000" + "RALPH", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "NAME.BAT.ZIP.3" + "\u0000" + "MICHAEL", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENDER.BAT.ZIP.0" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENDER.BAT.ZIP.1" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENDER.BAT.ZIP.2" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "GENDER.BAT.ZIP.3" + "\u0000" + "MALE", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "AGE.BAT.ZIP.0" + "\u0000" + "30", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "AGE.BAT.ZIP.1" + "\u0000" + "34", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "AGE.BAT.ZIP.2" + "\u0000" + "20", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "AGE.BAT.ZIP.3" + "\u0000" + "40", columnVisibilityEnglish, timeStamp, emptyValue);
            mutation.put(datatype + "\u0000" + caponeUID, "UUID.BAT.ZIP.2" + "\u0000" + "CAPONE", columnVisibilityEnglish, timeStamp, emptyValue);
