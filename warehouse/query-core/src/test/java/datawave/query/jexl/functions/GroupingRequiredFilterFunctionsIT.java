...
public class GroupingRequiredFilterFunctionsIT {
    ...
    private final Set<String> fields = Set.of("FIELD", "FIELD_A");
    ...
    public void setup() {
        ...
        metadata.put("FIELD_A", "datatype", LcType.class.getTypeName());
    ...
    @CsvSource(delimiter = ';', value = {
            ...
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.3=a,FIELD_A.1.2.3=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.3=a,FIELD_A.1.2.3=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.3=a,FIELD_A.1.1.3=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.3=a,FIELD_A.2.2.3=b; true",
            // none of these should match even though they match on the left
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.0=a,FIELD_A.1.2.1=b; false",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.0=a,FIELD_A.1.1.1=b; false",
            // no overlap should never match
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.0=a,FIELD_A.0.1.1=b; false",
            // it does not matter if there are the same number of groups, as long as the last one matches
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2=a,FIELD_A.2.2.2=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD.2=a,FIELD_A.2.2.2=b; true",
            // there must be at least one group on each field
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD=a,FIELD_A.2.2.2=b; false",
            // even if neither has a group it doesn't match in group
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b'); FIELD=a,FIELD_A=b; false",
            ...
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 0); FIELD.0.0.3=a,FIELD_A.9.9.3=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 0); FIELD.0.0.0=a,FIELD_A.9.9.9=b; false",
            // 1 - match two rightmost groups only
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 1); FIELD.1.2.3=a,FIELD_A.0.2.3=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 1); FIELD.1.2.3=a,FIELD_A.1.1.3=b; false",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 1); FIELD.1.2.3=a,FIELD_A.1.2.4=b; false",
            // 2 - can match all grouping
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 2); FIELD.1.2.3=a,FIELD_A.1.2.3=b; true",
            "grouping:matchesInGroup(FIELD, 'a', FIELD_A, 'b', 2); FIELD.1.2.3=a,FIELD_A.0.2.3=b; false",
            ...
            "grouping:matchesInGroup(FIELD, '.*', FIELD_A, 'b*'); FIELD.1.2.3=aaaaaaaa,FIELD_A.1.2.3=bbbbbbbbbb; true",
            // regex can include range quantifiers
            "grouping:matchesInGroup(FIELD, 'a{8}', FIELD_A, 'b*'); FIELD.1.2.3=aaaaaaaa,FIELD_A.1.2.3=bbbbbbbbbb; true",
            ...
            // 0 - explicit
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b', 0); FIELD.1.2.3=a,FIELD_A.0.2.3=b; false",
            // 0 - 1 does not match 0
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.3=a,FIELD_A.0.3.3=b; false",
            // 0 - explicit
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b', 0); FIELD.1.2.3=a,FIELD_A.0.3.3=b; false",
            // 0 - 1 does not match 0
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b'); FIELD.1.2.3=a,FIELD_A.0.2.4=b; false",
            // 0 - explicit
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b', 0); FIELD.1.2.3=a,FIELD_A.0.2.4=b; false",
            // 1 - 000.9999 matches 000.999
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b', 1); FIELD.000.999.0=a,FIELD_A.000.999.9=b; true",
            // 1 - 000.999 does not match 111.999
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b', 1); FIELD.000.999.0=a,FIELD_A.111.999.9=b; false",
            // 3 - if there aren't enough indexes in the group it can't be true even if otherwise is a match
            "grouping:matchesInGroupLeft(FIELD, 'a', FIELD_A, 'b', 3); FIELD.000.999.0=a,FIELD_A.000.999.0=b; false",
