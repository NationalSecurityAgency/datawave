...
public class TermCountingVisitorTest {
    ...
    public void testRangePlusTerm() throws ParseException {
        String query = "NUM >= '+aE1' && NUM <= '+aE4' && FOO == 'bar'";
        testCounts(query, 2);
    }
    
    @Test
    public void testWrappedRangePlusTerm() throws ParseException {
        String query = "(NUM >= '+aE1' && NUM <= '+aE4') && FOO == 'bar'";
        testCounts(query, 2);
    }
    
    @Test
    public void testUnorderedRangeAndTerm() throws ParseException {
        String query = "NUM >= '+aE1' && FOO == 'bar' && NUM <= '+aE4'";
        testCounts(query, 2);
    }
    
    @Test
    public void testWrappedUnorderedRangeAndTerm() throws ParseException {
        String query = "(NUM >= '+aE1' && FOO == 'bar') && NUM <= '+aE4'";
        testCounts(query, 2);
    }
    ...
    public void testTwoRangesForTheSameTerm() throws ParseException {
        String query = "(NUM >= '+aE1' && NUM <= '+aE4') || (NUM >= '+aE7' && NUM <= '+aE9')";
    ...
    @Test
    public void testTwoRangesPlusTerm_UnorderedWrapping() throws ParseException {
        String query = "NUM >= '+aE1' && (NUM <= '+aE4' && FOO == 'bar') && (NUM2 >= '+aE7' && NUM2 <= '+aE9')";
        testCounts(query, 3);
    }
    ...
    public void testQueryWithFunction() throws ParseException {
        String query = "(NUM >= '+aE1' && NUM <= '+aE4') || filter:includeRegex(FOO, '.*bar.*')";
        testCounts(query, 2);
    }
