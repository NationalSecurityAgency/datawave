...
public class JexlStringBuildingVisitorTest {
    ...
    /***** Testing building the query with no formatting at all *****/

    @Test
    public void testNegativeNumberNoFormatting() throws ParseException {
        String query = "BLAH == -2";
    ...
    @Test
    public void testSimpleOrNoFormatting() throws ParseException {
        String query = "(BLAH == -2 || FIELD == 'fieldname')";
    ...
    @Test
    public void testComplicatedQueryNoFormatting() throws ParseException {
    ...
    @Test
    public void testSimpleOrSomeFormatting() throws ParseException {
    ...
    @Test
    public void testSimpleOr1SomeFormatting() throws ParseException {
        String query = "BAR == 'foo' || BAR == 'blah'";
    ...
    @Test
    public void testSimpleOr2SomeFormatting() throws ParseException {
    ...
    @Test
    public void testNestedOrSomeFormatting() throws ParseException {
        String query = "((BAR == 'foo' || BAR == 'blah') || (BAR == 'test' || BAR == 'FOO'))";
        String expected = "(\n    (\n        BAR == 'foo' || \n        BAR == 'blah'\n    ) || \n    (\n        BAR == 'test' || \n        BAR == 'FOO'\n    )\n)";
        JexlNode node = JexlASTHelper.parseJexlQuery(query);
        String builtQuery = JexlStringBuildingVisitor.buildDecoratedQuery(node, false, true, new EmptyDecorator());
    ...
    @Test
    public void testNestedAndOrSomeFormatting() throws ParseException {
    ...
    @Test
    public void testComplicatedQuerySomeFormatting() throws ParseException {
    ...
    @Test
    public void testSimplerComplicatedQuerySomeFormatting() throws ParseException {
    ...
    @Test
    public void testBoundedNodeRangeSomeFormatting() throws ParseException {
    ...
    @Test
    public void testBoundedNodeSingleTermSomeFormatting() throws ParseException {
    ...
    @Test
    public void testMarkerNodesSingleTermSomeFormatting() throws ParseException {
    ...
    @Test
    public void testMarkerNodesSingleTerm1SomeFormatting() throws ParseException {
    ...
    @Test
    public void testMarkerNodesSingleTerm2SomeFormatting() throws ParseException {
        // Nested marker node anded with a single term, should be printed on same line
        String query = "(((_Value_ = true) && (BAR == 'foo')))";
        String expected = "(((_Value_ = true) && (BAR == 'foo')))";
        JexlNode node = JexlASTHelper.parseJexlQuery(query);
    ...
    @Test
    public void testMarkerNodeAndedMultipleTermsSomeFormatting() throws ParseException {
    ...
    @Test
    public void testMarkerNodeAndedMultipleTerms1SomeFormatting() throws ParseException {
        // Marker node anded with subtree (not single term or range), should be printed on separate lines
    ...
    @Test
    public void testNestedMarkerNodesSomeFormatting() throws ParseException {
    ...
    @Test
    public void testMultiParensIndentationSomeFormatting() throws ParseException {
    ...
    @Test
    public void testMultiParensIndentation1SomeFormatting() throws ParseException {
    ...
    @Test
    public void testMultiParensIndentation2SomeFormatting() throws ParseException {
        String query = "((((FOO == 'BAR' && ((_Eval_ = true) && (THIS == 'THAT')))))) && ((((FOO == 'BAR' && ((_Eval_ = true) && (THIS == 'THAT'))))))";
        String expected = "((((\n    FOO == 'BAR' && \n    ((_Eval_ = true) && (THIS == 'THAT'))\n)))) && "
                        + "\n((((\n    FOO == 'BAR' && \n    ((_Eval_ = true) && (THIS == 'THAT'))\n))))";
        JexlNode node = JexlASTHelper.parseJexlQuery(query);
    ...
    /***** Testing building the query with Bash decoration and formatted on multiple lines *****/
    ...
    /***** Testing building the query with HTML decoration and formatted on multiple lines *****/
