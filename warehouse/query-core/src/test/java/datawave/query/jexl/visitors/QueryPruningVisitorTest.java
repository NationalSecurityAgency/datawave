...
public class QueryPruningVisitorTest {
    ...
    public void falseAndTest() throws ParseException {
        ...
        ASTJexlScript script = JexlASTHelper.parseJexlQuery(query);
        Assertions.assertEquals(QueryPruningVisitor.TruthState.FALSE, QueryPruningVisitor.getState(script));
        
        Assertions.assertEquals(0, logAppender.getMessages().size(), logAppender.getMessages().size());
    }
    ...
    public void falseAndRewriteTest() throws ParseException {
        ...
        Assertions.assertFalse(jexlState);
        
        Assertions.assertEquals("false", JexlStringBuildingVisitor.buildQuery(reduced));
        Assertions.assertEquals("false", JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
        
        Assertions.assertEquals(2, logAppender.getMessages().size());
        Assertions.assertEquals("Pruning FIELD1 == 'x' && _NOFIELD_ == 'y' to false", logAppender.getMessages().get(0));
        Assertions.assertEquals("Query before prune: FIELD1 == 'x' && _NOFIELD_ == 'y'\nQuery after prune: false", logAppender.getMessages().get(1));
    }
    ...
    public void trueRewriteTest() throws ParseException {
        ...
        JexlEvaluation jexlEvaluation = new JexlEvaluation(JexlStringBuildingVisitor.buildQuery(reduced), new DefaultArithmetic());
        boolean jexlState = jexlEvaluation.apply(new Tuple3<>(new Key(), new Document(), new DatawaveJexlContext()));
        Assertions.assertTrue(jexlState);
        
        Assertions.assertEquals("true", JexlStringBuildingVisitor.buildQuery(reduced));
        Assertions.assertEquals("true", JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
        
        Assertions.assertEquals(2, logAppender.getMessages().size());
        Assertions.assertEquals("Pruning true || (FIELD1 == '1' && filter:isNull(FIELD2)) to true", logAppender.getMessages().get(0));
        Assertions.assertEquals("Query before prune: true || (FIELD1 == '1' && filter:isNull(FIELD2))\nQuery after prune: true",
    ...
    public void falseDoubleAndRewriteTest() throws ParseException {
        ...
        Assertions.assertEquals(2, logAppender.getMessages().size());
        Assertions.assertEquals("Pruning FIELD1 == 'x' && _NOFIELD_ == 'y' && FIELD2 == 'y' to false", logAppender.getMessages().get(0));
        Assertions.assertEquals("Query before prune: FIELD1 == 'x' && _NOFIELD_ == 'y' && FIELD2 == 'y'\nQuery after prune: false", logAppender.getMessages()
                        .get(1));
    }
    ...
    public void unknownOrTest() throws ParseException {
        String query = "FIELD1 == 'x' || _NOFIELD_ == 'y'";
        ASTJexlScript script = JexlASTHelper.parseJexlQuery(query);
        Assertions.assertEquals(QueryPruningVisitor.TruthState.UNKNOWN, QueryPruningVisitor.getState(script));
    ...
    public void trueOrTest() throws ParseException {
        ...
        ASTJexlScript script = JexlASTHelper.parseJexlQuery(query);
        Assertions.assertEquals(QueryPruningVisitor.TruthState.TRUE, QueryPruningVisitor.getState(script));
    ...
    public void branchedRewriteTest() throws ParseException {
        ...
        Assertions.assertEquals("FIELD1 == 'x'", JexlStringBuildingVisitor.buildQuery(reduced));
        Assertions.assertEquals("FIELD1 == 'x'", JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
        
        Assertions.assertEquals(3, logAppender.getMessages().size());
        Assertions.assertEquals("Pruning _NOFIELD_ == 'y' && FIELD2 == 'z' to false", logAppender.getMessages().get(0));
        Assertions.assertEquals("Pruning (_NOFIELD_ == 'y' && FIELD2 == 'z') from FIELD1 == 'x' || (_NOFIELD_ == 'y' && FIELD2 == 'z')", logAppender
                        .getMessages().get(1));
        Assertions.assertEquals("Query before prune: FIELD1 == 'x' || (_NOFIELD_ == 'y' && FIELD2 == 'z')\nQuery after prune: FIELD1 == 'x'", logAppender
                        .getMessages().get(2));
    }
    ...
    public void nestedBranchRewriteTest() throws ParseException {
        ...
        Assertions.assertEquals("FIELD2 == 'z'", JexlStringBuildingVisitor.buildQuery(reduced));
        Assertions.assertEquals("FIELD2 == 'z'", JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
        
        Assertions.assertEquals(3, logAppender.getMessages().size());
        Assertions.assertEquals("Pruning (_NOFIELD_ == 'x' || _NOFIELD_ == 'y') && _NOFIELD_ == 'z' to false", logAppender.getMessages().get(0));
        Assertions.assertEquals(
    ...
    public void deeplyNestedBranchRewriteTest() throws ParseException {
        ...
        Assertions.assertEquals(3, logAppender.getMessages().size(), logAppender.getMessages().size() + "");
        Assertions.assertEquals("Pruning (_NOFIELD_ == 'x' || _NOFIELD_ == 'y') && (_NOFIELD_ == 'a' || _NOFIELD_ == 'b') && _NOFIELD_ == 'z' to false",
    ...
    public void unchangedRewriteTest() throws ParseException {
        ...
        Assertions.assertEquals(query, JexlStringBuildingVisitor.buildQuery(reduced));
        Assertions.assertEquals(query, JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
    }
    ...
    public void LTTest() throws ParseException {
        String query = "FIELD < 'x'";
        ASTJexlScript script = JexlASTHelper.parseJexlQuery(query);
        Assertions.assertEquals(QueryPruningVisitor.getState(script), QueryPruningVisitor.TruthState.UNKNOWN);
    ...
    public void dualStatementQueryTest() throws ParseException {
        ...
        Assertions.assertEquals(QueryPruningVisitor.TruthState.TRUE, QueryPruningVisitor.getState(script));
        Assertions.assertEquals("(Expression = 'somevalue'); true", JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
        
        query = "(Expression = 'somevalue'); FIELD == 'x' && false";
        script = JexlASTHelper.parseJexlQuery(query);
        
        Assertions.assertEquals(QueryPruningVisitor.TruthState.UNKNOWN, QueryPruningVisitor.getState(script));
        Assertions.assertEquals("(Expression = 'somevalue'); false", JexlStringBuildingVisitor.buildQuery(QueryPruningVisitor.reduce(script, false)));
    }
    ...
    public void propertyMarkerTest() throws ParseException {
        ...
        Assertions.assertEquals(query, newQuery);
