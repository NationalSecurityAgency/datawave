...
public class SSDeepDataType extends AbstractDataTypeConfig {
    ...
    public enum SSDeepField {
        ...
        /**
         * A flag to set if we expect the field to be not returned as part of the headers. These fields are represented in the CSC as fieldName=fieldValue
         * pairs.
         */
    ...
    public SSDeepDataType(final String ssdeep, final String ingestFile, final FieldConfig config) throws IOException, URISyntaxException {
        ...
        this.hConf.set(this.dataType + TypeRegistry.HANDLER_CLASSES,
                        String.join(",", AbstractColumnBasedHandler.class.getName(), SSDeepIndexHandler.class.getName()));
