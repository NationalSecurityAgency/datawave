...
public class FacetedQueryLogicTest extends AbstractFunctionalQuery {
    ...
    private static final Logger log = LogManager.getLogger(FacetedQueryLogicTest.class);
    ...
    public static void setupClass() throws Exception {
        ...
        FacetQueryTestTableHelper facetQueryTestTableHelper = new FacetQueryTestTableHelper(FacetedQueryLogicTest.class.getName(), log, TEARDOWN.EVERY_OTHER,
                        INTERRUPT.NEVER);
