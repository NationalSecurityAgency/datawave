...
public class SSDeepFields extends AbstractFields {
    ...
    private static final Collection<String> index = Arrays.asList("CHECKSUM_SSDEEP", SSDeepDataType.SSDeepField.EVENT_ID.name(),
                    SSDeepDataType.SSDeepField.MD5.name());
