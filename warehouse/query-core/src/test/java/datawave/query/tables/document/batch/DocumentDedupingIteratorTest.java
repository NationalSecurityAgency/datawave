...
import datawave.query.tables.document.batch.DocumentDedupingIterator;
...
public class DocumentDedupingIteratorTest {
    
    public static final int DUPS_LIST_SZ = 2160;
    public static final int DEDUPED_LIST_SZ = 1500;
    private static List<SerializedDocumentIfc> DUPS_LIST;
    ...
    public void test_nodups() {
        ...
        Iterable<SerializedDocumentIfc> input = () -> new DocumentDedupingIterator(DUPS_LIST.iterator(), bloomExpected, bloomFpp);
        
        List<SerializedDocumentIfc> output = new ArrayList<>();
    ...
    private static class TestEntry implements SerializedDocumentIfc {
