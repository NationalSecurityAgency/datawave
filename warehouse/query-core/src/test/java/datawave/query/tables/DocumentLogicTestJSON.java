...
public class DocumentLogicTestJSON extends AbstractDocumentQueryTest {

    @ClassRule
    public static AccumuloSetup accumuloSetup = new AccumuloSetup();

    private static final Logger log = Logger.getLogger(DocumentLogicTestJSON.class);
