...
import datawave.query.testframework.AbstractDocumentQueryTestWithSpring;
...
public class DocumentLogicTestJSONWithSpring extends AbstractDocumentQueryTestWithSpring {

    @ClassRule
    public static AccumuloSetup accumuloSetup = new AccumuloSetup();

    private static final Logger log = Logger.getLogger(DocumentLogicTestJSONWithSpring.class);
    ...
    public static void filterSetup() throws Exception {
        ...
        returnType= DocumentSerialization.ReturnType.json;

    }

    public DocumentLogicTestJSONWithSpring() {
    ...
    public void testRegexPushdownAnyfield() throws Exception {
        ...
        ((DocumentQueryPlanner) (logic.getQueryPlanner())).setTransformRules(Collections.singletonList(rule));
