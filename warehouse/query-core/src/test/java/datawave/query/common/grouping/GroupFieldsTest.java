...
public class GroupFieldsTest {
    ...
    public void testRemappedGroupFieldsToString() {
        ...
        assertThat(groupFields.toString()).isEqualTo("GROUP(GENERE,GEN,AG,GENDER,AGE)|SUM(AG,AGE)|COUNT(NOME,NAME)|AVERAGE(AG,AGE)|MIN(GENERE,GEN,GENDER)|MAX(NOME,NAME)|MODEL_MAP(AG[AGE]:GEN[GENERE,GENDER]:NOME[NAME])");
    }
    ...
    public void testParsingRemappedGroupFields() {
        ...
        GroupFields actual = GroupFields.from("GROUP(AG,AGE)|SUM(AG,AGE)|COUNT(NOME,NAME)|AVERAGE(BAR)|MIN(BAT)|MAX(FOO)|MODEL_MAP(AG[AGE]:GEN[GENERE,GENDER]:NOME[NAME])");
    ...
    public void testSerialization() throws JsonProcessingException {
        ...
        assertThat(json).isEqualTo("\"GROUP(GENERE,GEN,AG,GENDER,AGE)|SUM(AG,AGE)|COUNT(NOME,NAME)|AVERAGE(AG,AGE)|MIN(GENERE,GEN,GENDER)|MAX(NOME,NAME)|MODEL_MAP(AG[AGE]:GEN[GENERE,GENDER]:NOME[NAME])\"");
    }
