...
public class RangeSplitterTest {
    ...
    /**
     * Test method for {@link nsa.datawave.core.iterators.RangeSplitter#RangeSplitter(org.apache.accumulo.core.data.Range, int)}.
     */
    @Test
    public void testRangeSplitterCq1() {
        ...
        for (Range range : splitter) {
            count++;
            Assert.assertEquals(true, range.isStartKeyInclusive());
            Assert.assertEquals(false, range.isEndKeyInclusive());
            if (lastRange != null) {
