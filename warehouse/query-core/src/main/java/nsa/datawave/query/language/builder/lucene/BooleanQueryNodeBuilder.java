...
import nsa.datawave.query.language.tree.OrNode;
...
public class BooleanQueryNodeBuilder implements QueryBuilder {
    ...
    public nsa.datawave.query.language.tree.QueryNode build(QueryNode queryNode) throws QueryNodeException {
        ...
        nsa.datawave.query.language.tree.QueryNode bNode = null;
        List<QueryNode> children = booleanNode.getChildren();
        
        if (children != null) {
            List<nsa.datawave.query.language.tree.QueryNode> childrenList = new ArrayList<>();
            ...
            for (QueryNode child : children) {
                ...
                if (obj != null) {
                    nsa.datawave.query.language.tree.QueryNode query = (nsa.datawave.query.language.tree.QueryNode) obj;
                    childrenList.add(query);
                }
            }
            
            nsa.datawave.query.language.tree.QueryNode[] childrenArray = new nsa.datawave.query.language.tree.QueryNode[childrenList.size()];
    ...
    private nsa.datawave.query.language.tree.QueryNode createNode(QueryNode queryNode, nsa.datawave.query.language.tree.QueryNode[] childrenArray,
                    boolean isNegation, LinkedList<QueryNode> extraNodeList) throws QueryNodeException {
        nsa.datawave.query.language.tree.QueryNode bNode = null;
