...
import nsa.datawave.query.language.tree.AdjNode;
import nsa.datawave.query.language.tree.SelectorNode;
import nsa.datawave.query.language.tree.WithinNode;
...
public class SlopQueryNodeBuilder implements QueryBuilder {
    ...
    public nsa.datawave.query.language.tree.QueryNode build(QueryNode queryNode) throws QueryNodeException {
        ...
        nsa.datawave.query.language.tree.QueryNode node = (nsa.datawave.query.language.tree.QueryNode) phraseSlopNode.getChild().getTag(
                        QueryTreeBuilder.QUERY_TREE_BUILDER_TAGID);
        
        if (node instanceof AdjNode) {
            nsa.datawave.query.language.tree.QueryNode[] nodeArray = new nsa.datawave.query.language.tree.QueryNode[node.getChildren().size()];
