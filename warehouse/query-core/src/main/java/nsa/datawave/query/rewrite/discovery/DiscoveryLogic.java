...
import static nsa.datawave.query.rewrite.jexl.lookups.RefactoredShardIndexQueryTableStaticMethods.configureGlobalIndexDataTypeFilter;
import static nsa.datawave.query.rewrite.jexl.lookups.RefactoredShardIndexQueryTableStaticMethods.configureGlobalIndexDateRangeFilter;
import static nsa.datawave.query.rewrite.jexl.lookups.RefactoredShardIndexQueryTableStaticMethods.getLiteralRange;
...
import nsa.datawave.query.rewrite.discovery.FindLiteralsAndPatternsVisitor.QueryValues;
import nsa.datawave.query.rewrite.exceptions.IllegalRangeArgumentException;
...
public class DiscoveryLogic extends RefactoredShardIndexQueryTable {
    ...
    public static Pair<Set<Range>,Set<Range>> makeRanges(DiscoveryQueryConfiguration config, Set<Text> familiesToSeek, MetadataHelper metadataHelper)
        ...
        for (Entry<String,String> literalAndField : config.getLiterals().entries()) {
            ...
            forwardRanges.add(getLiteralRange(field, literal));
        }
