...
import nsa.datawave.query.rewrite.exceptions.LoadAverageWatchException;
import nsa.datawave.query.rewrite.iterator.errors.ErrorKey;
import nsa.datawave.query.rewrite.iterator.errors.ErrorType;
import nsa.datawave.query.rewrite.iterator.errors.UnindexedException;
import nsa.datawave.query.util.QueryInformation;
