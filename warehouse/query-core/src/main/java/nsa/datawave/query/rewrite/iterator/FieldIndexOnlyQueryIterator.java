...
import nsa.datawave.query.rewrite.function.LogTiming;
import nsa.datawave.query.rewrite.function.MaskedValueFilterFactory;
import nsa.datawave.query.rewrite.function.MaskedValueFilterInterface;
import nsa.datawave.query.rewrite.iterator.profile.EvaluationTrackingFunction;
import nsa.datawave.query.rewrite.iterator.profile.QuerySpan;
import nsa.datawave.query.rewrite.iterator.profile.SourceTrackingIterator;
import nsa.datawave.query.rewrite.jexl.visitors.SatisfactionVisitor;
...
import nsa.datawave.query.rewrite.function.DataTypeAsField;
import nsa.datawave.query.rewrite.function.GetStartKey;
import nsa.datawave.query.rewrite.function.PrefixEquality;
import nsa.datawave.query.rewrite.function.serializer.KryoDocumentSerializer;
...
import nsa.datawave.query.rewrite.iterator.errors.UnindexedException;
import nsa.datawave.query.rewrite.iterator.filter.EventKeyDataTypeFilter;
import nsa.datawave.query.rewrite.iterator.filter.FieldIndexKeyDataTypeFilter;
import nsa.datawave.query.rewrite.iterator.filter.KeyIdentity;
import nsa.datawave.query.rewrite.iterator.filter.StringToText;
...
public class FieldIndexOnlyQueryIterator extends QueryIterator {
    ...
    protected void createAndSeekIndexIterator(Range range, Collection<ByteSequence> columnFamilies, boolean inclusive) throws IOException {
        ...
        Set<String> keys = QueryOptions.fetchDatatypeKeys(this.documentOptions.get(NON_INDEXED_DATATYPES));
