...
public class QueryParameters {
    ...
    /**
     * The classname of the return uid mapper class. To return the parent document, this should be nsa.datawave.core.iterators.uid.ParentDocumentUidMapper. To
     * return the top level document, this should be nsa.datawave.core.iterators.uid.TopLevelDocumentUidMapper.
     */
     ...
     * nsa.datawave.core.iterators.uid.TopLevelDocumentUidMapper.
     */
