...
import nsa.datawave.query.cardinality.CardinalityRecord;
...
import nsa.datawave.webservice.query.exception.EmptyObjectException;
import nsa.datawave.webservice.query.logic.BaseQueryLogic;
import nsa.datawave.webservice.query.logic.WritesQueryMetrics;
import nsa.datawave.webservice.query.logic.WritesResultCardinalities;
...
public class DocumentTransformer extends EventQueryTransformer implements WritesQueryMetrics, WritesResultCardinalities {
    ...
    protected Collection<FieldBase<?>> buildDocumentFields(Key documentKey, String documentName, Document document, ColumnVisibility topLevelColumnVisibility,
        ...
        for (Entry<String,Attribute<? extends Comparable<?>>> data : documentData.entrySet()) {
            ...
            if (data.getValue() instanceof nsa.datawave.query.rewrite.attributes.Metadata) {
                continue;
            }
