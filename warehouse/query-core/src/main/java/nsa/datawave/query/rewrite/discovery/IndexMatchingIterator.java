...
import static nsa.datawave.query.rewrite.iterator.UniqueColumnFamilyIterator.moveTo;
...
import nsa.datawave.core.iterators.filter.GlobalIndexTermMatchingFilter;
            ...
            if (matches.getValue0()) {
                ...
                if (maybeFields.isPresent()) {
                    ...
                    if (field.equals(possibleMatch)) {
                        ...
                        moveTo(next, src, scanRange, scanCFs, scanInclusive);
                        continue;
                    }
                } else {
                ...
                moveTo(key.followingKey(PartialKey.ROW), src, scanRange, scanCFs, scanInclusive);
            }
        }
    }
