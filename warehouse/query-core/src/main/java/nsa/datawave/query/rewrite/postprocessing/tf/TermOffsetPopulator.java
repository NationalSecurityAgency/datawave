...
import nsa.datawave.core.iterators.TermFrequencyIterator;
import nsa.datawave.core.iterators.TermFrequencyIterator.FieldValue;
...
import nsa.datawave.query.rewrite.jexl.functions.ContentFunctions;
import nsa.datawave.query.rewrite.jexl.functions.TermFrequencyList;
...
public class TermOffsetPopulator {
    ...
    public Map<String,Object> getContextMap(Key docKey, Set<Key> keys) {
        ...
        while (tfSource.hasTop()) {
            ...
            TreeMultimap<Zone,Integer> offsets = TreeMultimap.create();
            try {
                ...
                offsets.putAll(new Zone(fv.getField(), (contentExpansionFields == null || contentExpansionFields.isEmpty() || contentExpansionFields
                                .contains(fv.getField())), TermFrequencyList.getEventId(key)), twInfo.getTermOffsetList());
