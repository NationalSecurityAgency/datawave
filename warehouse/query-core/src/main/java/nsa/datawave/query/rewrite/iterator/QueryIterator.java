...
import nsa.datawave.query.rewrite.jexl.StatefulArithmetic;
import nsa.datawave.query.rewrite.jexl.functions.IdentityAggregator;
import nsa.datawave.query.rewrite.jexl.functions.KeyAdjudicator;
...
public class QueryIterator extends QueryOptions implements SortedKeyValueIterator<Key,Value>, JexlContextCreator.JexlContextValueComparator,
    ...
    public static boolean isDocumentSpecificRange(Range r) {
        ...
        //
        // Also @see nsa.datawave.query.index.lookup.TupleToRange
