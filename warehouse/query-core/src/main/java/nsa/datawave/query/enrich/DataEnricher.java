package nsa.datawave.query.enrich;
 ...
 * 
 * <p>
 * After instantiating a {@link DataEnricher}, the user must call the {@link #init(SortedKeyValueIterator, Map)} method. This will initialize the
 * {@link DataEnricher} and prepare it to enrich results.
 * </p>
 * 
 * <p>
