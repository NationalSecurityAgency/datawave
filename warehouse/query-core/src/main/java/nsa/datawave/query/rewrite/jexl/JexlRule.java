...
public class JexlRule extends AppliedRule {
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.iterators.filter.ageoff.AppliedRule#accept(nsa.datawave.iterators.filter.ageoff.AgeOffPeriod, org.apache.accumulo.core.data.Key,
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.iterators.filter.ageoff.AppliedRule#isFilterRuleApplied()
     */
    @Override
