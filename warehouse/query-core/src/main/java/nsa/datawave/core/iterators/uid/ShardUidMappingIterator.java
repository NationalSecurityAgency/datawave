package nsa.datawave.core.iterators.uid;
 ...
 * 
 * 
 * @see nsa.datawave.core.iterators.uid.UidMapper
 * 
 */
public class ShardUidMappingIterator extends UidMappingIterator {
     ...
     * 
     * @see nsa.datawave.core.iterators.uid.UidMappingIterator#mapSeek(org.apache.accumulo.core.data.Range, java.util.Collection, boolean)
     */
    @Override
