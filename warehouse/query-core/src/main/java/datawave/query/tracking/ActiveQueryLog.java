...
public class ActiveQueryLog {
    ...
    synchronized public static void setConfig(final Configuration conf) {
        if (conf != null) {
    ...
    private ActiveQueryLog(Configuration conf, String name) {
        if (conf != null) {
    ...
    private void checkSettings(Configuration conf, boolean useDefaults) {
