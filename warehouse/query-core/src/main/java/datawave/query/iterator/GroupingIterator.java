        ...
        for (int i = 0; i < groupFieldsBatchSize; i++) {
            if (previousIterators.hasNext()) {
                ...
                if (entry != null) {
                    ...
                    GroupingUtil.GroupingInfo groupingInfo = groupingUtil.getGroupingInfo(entry, markingFunctions, groupFieldsSet);
...
//        return next != null;
     ...
     *
     * @param documents  the list of documents to flatten into a single document
     */
