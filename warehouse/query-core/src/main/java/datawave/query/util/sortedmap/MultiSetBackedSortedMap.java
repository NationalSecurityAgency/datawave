 ...
 */
public class MultiSetBackedSortedMap<E> extends AbstractSet<E> implements RewritableSortedSet<E> {
    ...
    public MultiSetBackedSortedMap() {}

    public MultiSetBackedSortedMap(List<SortedSet<E>> sets) {
    ...
    public RewritableSortedSet<E> subSet(E fromElement, E toElement) {
        MultiSetBackedSortedMap<E> subSet = new MultiSetBackedSortedMap<>();
        for (SortedSet<E> set : sets) {
