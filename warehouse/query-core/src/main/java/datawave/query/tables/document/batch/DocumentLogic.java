...
public class DocumentLogic extends BaseQueryLogic<Document> {
    ...
    public void initialize(DocumentQueryConfiguration config, AccumuloClient client, Query settings, Set<Authorizations> auths) throws Exception {
        ...
        setScannerFactory(new MyScannerFactory(config));
    ...
    protected MetadataHelper prepareMetadataHelper(AccumuloClient client, String metadataTableName, Set<Authorizations> auths, boolean rawTypes) {
        ...
        return metadataHelperFactory.createMetadataHelper(client, metadataTableName, auths, rawTypes);
    }
    ...
    public void setupQuery(GenericQueryConfiguration genericConfig) throws Exception {
        if (!DocumentQueryConfiguration.class.isAssignableFrom(genericConfig.getClass())) {
            throw new QueryException("Did not receive a DocumentQueryConfiguration instance!!");
        }
     ...
     */
    protected void loadQueryModel(MetadataHelper helper, DocumentQueryConfiguration config) throws InstantiationException, IllegalAccessException,
