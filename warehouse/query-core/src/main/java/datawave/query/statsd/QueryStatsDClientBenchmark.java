...
public class QueryStatsDClientBenchmark {

        private QueryStatsDClient qc;

        public QueryStatsDClientBenchmark(){
        ...
        public static void main(String[] args) throws RunnerException {
            ...
            for (int t : threadCounts) {
                ...
                System.out.println("===========================================");
                Options opt = new OptionsBuilder().include(datawave.query.statsd.QueryStatsDClientBenchmark.class.getSimpleName())
                        .threads(t).
                        forks(1).build();
                new Runner(opt).run();
            }
