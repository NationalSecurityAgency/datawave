...
import datawave.query.language.functions.jexl.UniqueByTenth;
...
public class JexlTreeBuilder extends QueryTreeBuilder {
    ...
    public static final JexlQueryFunction[] DEFAULT_ALLOWED_FUNCTIONS = {new IsNull(), new IsNotNull(), new Include(), new Exclude(), new Text(),
            ...
            new EvaluationOnly(), new UniqueByDay(), new UniqueByHour(), new UniqueByTenth(), new UniqueByMonth(), new UniqueByYear(), new UniqueByMinute(),
            new NoExpansion(), new Compare(), new ExcerptFields()};
