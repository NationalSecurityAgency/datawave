...
/**
 * Function to specify when summaries should be included for results for any hit documents. With no arguments, the default summary options are used. Otherwise,
 * this function accepts a string in the format {@code size/[only]/[contentName1, contentName2, ....]}. See {@link datawave.query.attributes.SummaryOptions} for
