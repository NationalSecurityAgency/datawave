...
public class ShardQueryConfiguration extends GenericQueryConfiguration implements Serializable {
    ...
    private Set<String> excludedFields = new HashSet<>(0);
    ...
    public ShardQueryConfiguration(ShardQueryConfiguration other) {
        ...
        this.setExcludedFields(null == other.getExcludedFields() ? null : Sets.newHashSet(other.getExcludedFields()));
    ...
    public void setExcludedFields(Set<String> excludedFields) {
        this.excludedFields = deconstruct(excludedFields);
    }

    @JsonIgnore
    public String getExcludedFieldsAsString() {
        return StringUtils.join(this.getExcludedFields(), Constants.PARAM_VALUE_SEP);
    }
