...
public class TLDQueryIterator extends QueryIterator {
    ...
    public EventDataQueryFilter getEvaluationFilter() {
        if (this.evaluationFilter == null && script != null) {
            ...
            this.evaluationFilter = new TLDEventDataFilter(script, getAllFields(), typeMetadata, includeListedFields ? includedFields : null,
                            excludeListedFields ? excludedFields : null, getEventFieldSeek(), getEventNextSeek(),
