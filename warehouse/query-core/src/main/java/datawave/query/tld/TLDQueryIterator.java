...
public class TLDQueryIterator extends QueryIterator {
    ...
    public EventDataQueryFilter getEvaluationFilter() {
        if (this.evaluationFilter == null && script != null) {
            ...
            this.evaluationFilter = new TLDEventDataFilter(script, getAllFields(), typeMetadata, useIncludeListedFields ? includeListedFields : null,
                            useExcludeListedFields ? excludeListedFields : null, getEventFieldSeek(), getEventNextSeek(),
