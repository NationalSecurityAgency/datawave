...
public class TermExtractor implements Serializable {
    ...
    public Set<String> extract(String jexlQueryString, Normalizer<String> normalizer) throws ParseException, JavaRegexAnalyzer.JavaRegexParseException {
        // Keep the legacy set-returning API, but share the AST walk (including negation
        // handling and field matching) with structured extraction.
        return JexlSearchExpressionExtractor.extractStandalone(jexlQueryString, fields, normalizer);
    }
}
