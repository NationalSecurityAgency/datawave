 ...
 */
public class DocumentPushdownScheduler extends Scheduler<Document> {
    ...
    public DocumentPushdownScheduler(ShardQueryConfiguration config, ScannerFactory scannerFactory, MetadataHelperFactory metaFactory) {
    ...
    protected DocumentPushdownScheduler(ShardQueryConfiguration config, ScannerFactory scannerFactory, MetadataHelper helper) {
        this.config = config;
     ...
     */
    protected Iterator<Document> concatIterators() throws AccumuloException, AccumuloSecurityException, TableNotFoundException, ParseException {
