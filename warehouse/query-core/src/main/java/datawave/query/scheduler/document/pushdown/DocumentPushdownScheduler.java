package datawave.query.scheduler.document.pushdown;
 ...
 */
public class DocumentPushdownScheduler extends Scheduler<SerializedDocumentIfc> {

    private static final Logger log = ThreadConfigurableLogger.getLogger(DocumentPushdownScheduler.class);
    ...
    protected Iterator<SerializedDocumentIfc> currentIterator = null;
    ...
    public DocumentPushdownScheduler(DocumentQueryConfiguration config, ScannerFactory scannerFactory, MetadataHelperFactory metaFactory) {
    ...
    protected DocumentPushdownScheduler(DocumentQueryConfiguration config, ScannerFactory scannerFactory, MetadataHelper helper) {
        this.config = config;
     ...
     */
    protected Iterator<SerializedDocumentIfc> concatIterators() throws AccumuloException, AccumuloSecurityException, TableNotFoundException, ParseException {
