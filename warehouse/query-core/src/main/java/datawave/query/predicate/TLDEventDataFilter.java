...
public class TLDEventDataFilter extends EventDataQueryExpressionFilter {
     ...
     * @param endKeyInclusive the range end inclusive flag
     * @param sortedWhitelist the sortedWhitelist to use
     * @param lastHit         the starting index to search the whitelist
     ...
     *
     * @param whitelist the list of whitelist queryFields or null if not using a whitelist
     * @param blacklist the list of blacklist queryFields or null if not using a blacklist
     */
     ...
     *
     * @param whitelist the whitelist modified by queryFields
     * @param blacklist the blacklist modified by queryFields
     */
