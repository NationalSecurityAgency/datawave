...
public class DiscoveryLogic extends ShardIndexQueryTable {
     ...
     * @param familiesToSeek the families to seek
     * @param metadataHelper a metadata helper
     ...
     *
     * @param normalization  the normalizer object
     * @param valuesToFields mapping of values to fields
     ...
     *
     * @param things iterable list of objects
