...
import datawave.query.rewrite.jexl.functions.ContentFunctionsDescriptor.ContentJexlArgumentDescriptor;
...
public class SatisfactionVisitor extends BaseVisitor {
     ...
     * {@link ContentJexlArgumentDescriptor}, which produces a tree of JexlNodes. This will allow us to create an iterator tree across the expression that tree
     * represents and consider the TF fields when doing an index look up. This also enables us to perform an index lookup when the query is only a content
     * function.
     */
    @Override
