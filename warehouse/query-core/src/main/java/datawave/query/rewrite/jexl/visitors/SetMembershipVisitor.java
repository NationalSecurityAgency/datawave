...
public class SetMembershipVisitor extends BaseVisitor {
     ...
     * renamed and specially handled for fetching and evaluation via the {@link datawave.query.rewrite.jexl.IndexOnlyJexlContext}.
     * 
     ...
     * 
     * @see datawave.query.rewrite.function.IndexOnlyContextCreator
     */
