package datawave.query.rewrite.jexl.nodes;
...
public class IndexHoleMarkerJexlNode extends QueryPropertyMarker {
    ...
    public static boolean instanceOf(JexlNode node) {
        return QueryPropertyMarker.instanceOf(node, IndexHoleMarkerJexlNode.class);
    }
    ...
    public static JexlNode getIndexHoleSource(JexlNode node) {
        return QueryPropertyMarker.getQueryPropertySource(node, IndexHoleMarkerJexlNode.class);
    }
