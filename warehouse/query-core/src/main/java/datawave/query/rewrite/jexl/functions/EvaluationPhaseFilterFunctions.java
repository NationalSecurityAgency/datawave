...
import datawave.query.rewrite.jexl.JexlPatternCache;
 ...
 *
 **/
@JexlFunctions(descriptorFactory = "datawave.query.rewrite.jexl.functions.EvaluationPhaseFilterFunctionsDescriptor")
