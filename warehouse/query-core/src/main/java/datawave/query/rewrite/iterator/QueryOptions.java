...
import datawave.query.rewrite.function.ConfiguredFunction;
...
import datawave.query.rewrite.jexl.HitListArithmetic;
...
public class QueryOptions implements OptionDescriber {
    ...
    protected ReturnType returnType = ReturnType.kryo;
