package datawave.query.rewrite.planner.pushdown.rules;
...
public class DelayedPredicatePushDown extends PushDownRule {
     ...
     * (non-Javadoc)
     * 
     * @see datawave.query.rewrite.planner.pushdown.PushDownRule#getCost(org.apache.commons.jexl2.parser.JexlNode)
     */
    @Override
