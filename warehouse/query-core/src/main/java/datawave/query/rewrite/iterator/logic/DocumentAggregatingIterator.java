...
public class DocumentAggregatingIterator extends WrappingIterator implements DocumentIterator {
     ...
     * (non-Javadoc)
     * 
     * @see datawave.query.rewrite.iterator.IndexDocumentIterator#document()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see datawave.query.rewrite.iterator.IndexDocumentIterator#move(org.apache.accumulo.core.data.Key)
     */
    @Override
