...
import datawave.query.rewrite.jexl.lookups.IndexLookup;
import datawave.query.rewrite.jexl.lookups.IndexLookupMap;
...
import datawave.query.rewrite.planner.pushdown.Cost;
import datawave.query.rewrite.planner.pushdown.CostEstimator;
...
public class RangeConjunctionRebuildingVisitor extends RebuildingVisitor {
    ...
    protected JexlNode expandIndexBoundedRange(Map<LiteralRange<?>,List<JexlNode>> ranges, List<JexlNode> leaves, ASTAndNode currentNode, JexlNode newNode,
        ...
        for (Map.Entry<LiteralRange<?>,List<JexlNode>> range : ranges.entrySet()) {
            ...
            JexlNode orNode = JexlNodeFactory.createNodeTreeFromFieldsToValues(ContainerType.OR_NODE, new ASTEQNode(ParserTreeConstants.JJTEQNODE),
                            onlyRangeNodes, fieldsToTerms);
