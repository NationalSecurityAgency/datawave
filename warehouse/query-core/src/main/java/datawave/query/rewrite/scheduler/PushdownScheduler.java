package datawave.query.rewrite.scheduler;
...
public class PushdownScheduler extends Scheduler {
     ...
     * (non-Javadoc)
     * 
     * @see datawave.query.rewrite.scheduler.Scheduler#createBatchScanner(datawave.query.rewrite.config.RefactoredShardQueryConfiguration,
     * datawave.query.tables.ScannerFactory, datawave.webservice.query.configuration.QueryData)
     */
    @Override
