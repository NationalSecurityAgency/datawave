 ...
 * are returned.
 */
public class AncestorEventDataFilter extends EventDataQueryFilter implements Filter {
    /**
     ...
     * (non-Javadoc)
     * 
     * @see datawave.query.rewrite.function.Filter#accept(org.apache.accumulo.core.data.Key)
     */
    @Override
