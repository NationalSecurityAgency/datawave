package datawave.query.rewrite.tables.facets;
...
import datawave.query.rewrite.transformer.FacetedTransformer;
...
import datawave.query.rewrite.function.FacetedGrouping;
import datawave.query.rewrite.function.deserializer.DocumentDeserializer;
import datawave.query.rewrite.function.serializer.DocumentSerializer;
...
public class FacetedQueryLogic extends IndexQueryLogic {
    ...
    public void setupQuery(GenericQueryConfiguration configuration) throws Exception {
        ...
        Iterator<Entry<Key,Value>> returnIter = new MergedReadAhead<Entry<Key,Value>>(facetedConfig, iterator, new FacetedFunction(deserializer, serializer,
                        functionList), filterList);
