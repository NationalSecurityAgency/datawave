...
public class QueryFunctions {
    ...
    public static final String UNIQUE_BY_ORIGINAL_FUNCTION = "original";
    public static final String UNIQUE_BY_DAY_FUNCTION = "day";
    public static final String UNIQUE_BY_HOUR_FUNCTION = "hour";
    public static final String UNIQUE_BY_MINUTE_FUNCTION = "minute";
