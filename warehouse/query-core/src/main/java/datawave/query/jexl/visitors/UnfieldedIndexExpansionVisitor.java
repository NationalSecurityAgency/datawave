...
public class UnfieldedIndexExpansionVisitor extends RegexIndexExpansionVisitor {
    ...
    // This contains the fields we look up against the index and their expansions for each term expanded in this visitor. This will allow us to avoid
    // performing lookups on the same fields multiple times.
    private ExpandedFieldCache expandedFieldCache = new ExpandedFieldCache();
