...
| Done?   | Method        | Operation                            | Description                                                                       | Path Param         | Request Body         | Response Body                            |
|:--------|:--------------|:-------------------------------------|:----------------------------------------------------------------------------------|:-------------------|:---------------------|:-----------------------------------------|
...
| &check; | `PUT` `POST`  | /{id}/reset                          | Resets the specified query                                                        | [QueryId]          | N/A                  | [VoidResponse]                           |
...
| &check; | `PUT` `POST`  | /{id}/adminClose                     | Closes the specified query                                                        | [QueryId]          | N/A                  | [VoidResponse]                           |
| &check; | `PUT` `POST`  | /{id}/cancel                         | Cancels the specified query                                                       | [QueryId]          | N/A                  | [VoidResponse]                           |
| &check; | `PUT` `POST`  | /{id}/adminCancel                    | Cancels the specified query                                                       | [QueryId]          | N/A                  | [VoidResponse]                           |
