...
public class Next extends ExecutorAction {
    ...
    public Next(QueryExecutor source, ExecutorProperties executorProperties, QueryProperties queryProperties, BusProperties busProperties, Connector connector,
