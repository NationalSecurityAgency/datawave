...
|No|ModificationBean|/Modification|Keep|?|?|Is this used anywhere?  Do we need this?  It allows us to list and modify modification services.|
|No|ModificationCacheBean|/Modification|Keep|?|?|Is this used anywhere?  Do we need this?  It allows us to list mutable fields and reload the mutable field cache.|
...
|No|IdTranslatorBean|/Query|Keep|?|?|Not sure what to do with this.|
