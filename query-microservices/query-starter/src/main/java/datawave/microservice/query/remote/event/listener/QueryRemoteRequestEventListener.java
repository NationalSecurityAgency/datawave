package datawave.microservice.query.event.listener;
...
public class QueryRemoteRequestEventListener implements ApplicationListener<QueryRemoteRequestEvent> {
    ...
    @Override
    public void onApplicationEvent(QueryRemoteRequestEvent event) {
