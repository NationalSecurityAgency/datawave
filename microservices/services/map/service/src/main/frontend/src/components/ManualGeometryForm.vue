  ...
  <q-card>
    <q-card-section class="q-py-none">
      <q-form>
        ...
        <div class="q-py-sm">
          <q-toggle
            v-model="manualGeometryForm.createRanges"
        ...
        <div v-if="manualGeometryForm.createRanges">
          <div class="q-py-sm">
            <q-btn-toggle
              v-model="manualGeometryForm.rangeType"
          ...
          <div>
            ...
            <div class="row">
              <div class="col">
                <q-input
                  v-model="
                    manualGeometryForm.rangeSettings[
                      manualGeometryForm.rangeType
                    ].maxEnvelopes
                  "
    ...
    <q-card style="min-width: 66%">
      ...
      <q-card-actions align="right" class="text-primary">
        ...
        <q-btn
          ...
          v-close-popup
          @click="
            manualGeometryForm.geometry = editDialogText;
            editDialogText = '';
          "
        />
      </q-card-actions>
