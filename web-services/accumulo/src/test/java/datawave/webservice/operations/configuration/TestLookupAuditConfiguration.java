...
public class TestLookupAuditConfiguration {
    ...
    public void testNoAuditOfColFamInTable() {
        ...
        LookupAuditConfiguration l2 = new LookupAuditConfiguration(TableName.SHARD, "[0-9]{8}_[0-9]+", "d", ".*CONTENT", AuditType.NONE);
        assertTrue(l2.isMatch(TableName.SHARD, "20120112_100", "d", "datatype\\x00-103s6q.-y9weab.-50ho6n\\x00CONTENT"));
        assertFalse(l2.isMatch(TableName.SHARD, "20120112_100", null, null));
    }
}
