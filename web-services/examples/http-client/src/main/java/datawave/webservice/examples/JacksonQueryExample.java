    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            if (responseCode != HttpStatus.SC_OK) {
                ...
                BaseQueryResponse baseQueryResponse = mapper.readValue(response.getEntity().getContent(), responseClass);
        ...
        VoidResponse closeResponse = mapper.readValue(response.getEntity().getContent(), VoidResponse.class);
