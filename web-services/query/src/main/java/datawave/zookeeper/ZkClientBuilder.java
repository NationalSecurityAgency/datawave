...
public class ZkClientBuilder {
     ...
     * @throws IllegalStateException if the client does not connect to Zookeeper within the configured timeout
     */
     ...
     * @param timeUnit
     *            the time unit for the max wait time
     * @param failOnTimeoutExceeded whether to throw an exception if the client does not connect to Zookeeper within the timeout
     * @return the started client
     * @throws Exception
     *             if an error occurs while creating the builder for the client, or while waiting for the client to connect
     * @throws IllegalStateException if the client does not connect to Zookeeper within the configured timeout
