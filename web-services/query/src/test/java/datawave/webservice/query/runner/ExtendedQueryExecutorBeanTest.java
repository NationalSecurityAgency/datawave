...
public class ExtendedQueryExecutorBeanTest {
    ...
    // assertEquals("500-9", ((QueryException) result1.getCause()
    // .getCause()).getErrorCode(), "Expected DatawaveWebApplicationException to have been caused by a locked cache entry");
    // }
    //
    // @Test(expected = DatawaveWebApplicationException.class)
    ...
    // assertEquals("None of the DNs used have access to this query logic: [userDN]",
    // result1.getMessage(), "Thrown exception expected to detail reason for access denial");
    // }
    //
    // @SuppressWarnings({"rawtypes", "unchecked"})
    // @Test
