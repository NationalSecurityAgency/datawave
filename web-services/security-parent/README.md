...
## [datawave-ws-security-examples](security-examples)
Contains examples for performing a programmatic authentication to execute operations on EJBs from a secured context.
