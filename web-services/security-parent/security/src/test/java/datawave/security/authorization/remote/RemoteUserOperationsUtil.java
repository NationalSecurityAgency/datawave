...
public class RemoteUserOperationsUtil extends RemoteServiceUtil {
    ...
    public RemoteUserOperationsImpl getUserOperations() throws CertificateException, NoSuchAlgorithmException {
        ...
        remote.setSslStores(sslStores());

        return remote;
    }

    private SSLStores sslStores() throws CertificateException, NoSuchAlgorithmException {
        String alias = "tomcat";
        ...
        return new TestSSLStores(alias, privKey, keyPass, chain);
    }
