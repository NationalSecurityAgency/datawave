...
public class QueryParametersImpl implements QueryParameters {
    ...
    /**
     * Convenience method to generate a Map<String,List<String>> from the specified arguments. If an argument is null, it's associated parameter name (key) will not be
