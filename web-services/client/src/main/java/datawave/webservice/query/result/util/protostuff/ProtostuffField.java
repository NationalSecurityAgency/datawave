...
public class ProtostuffField<E extends Enum<E> & FieldAccessor> implements FieldParser {
     ...
     * (non-Javadoc)
     * 
     * @see datawave.webservice.query.result.util.protostuff.FieldParser#parseFieldNumber(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see datawave.webservice.query.result.util.protostuff.FieldParser#parseFieldName(java.lang.String)
     */
