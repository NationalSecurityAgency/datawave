...
public class ProtostuffFieldTest {
    ...
    private final ProtostuffField<FIELD_BASE> FIELD = new ProtostuffField<FIELD_BASE>(FIELD_BASE.class);
    ...
    private enum BAD_BASE implements FieldAccessor {
        ...
        private BAD_BASE(int fn, String name) {
            this.fn = fn;
            this.name = name;
        }
    ...
    public void testInvalidEnum() {
        ...
        ProtostuffField<BAD_BASE> ERROR_OUT = new ProtostuffField<BAD_BASE>(BAD_BASE.class);
    }
}
