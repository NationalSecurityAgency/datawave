...
public class DatawavePrincipalLookupBean implements DatawavePrincipalLookup {
     ...
     * (non-Javadoc)
     * 
     * @see datawave.security.authorization.DatawavePrincipalLookup#lookupPrincipal(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see datawave.security.authorization.DatawavePrincipalLookup#getCurrentPrincipal()
     */
    @Override
