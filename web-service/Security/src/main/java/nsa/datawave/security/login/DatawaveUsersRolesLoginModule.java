 ...
 * credential, which in our case will be a {@link nsa.datawave.security.auth.DatawaveCredential}, and turn it to a string, so the password used in the
 * associated properties file must match the {@code toString()} version of the credential.
 */
