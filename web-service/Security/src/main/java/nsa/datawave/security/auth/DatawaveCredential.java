...
public class DatawaveCredential implements Credential, Comparable<DatawaveCredential> {
     ...
     * if the {@link nsa.datawave.security.login.DatawavePrincipalLoginModule} is configured with trusted header login (i.e., it is configured to trust the
     * incoming DN information without a supplied certificate).
     *
     * @param subjectDN
