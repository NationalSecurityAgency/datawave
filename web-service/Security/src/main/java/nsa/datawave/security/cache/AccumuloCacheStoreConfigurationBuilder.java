...
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.INSTANCE;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.INSTANCE_NAME;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.ZOOKEEPERS;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.USERNAME;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.PASSWORD;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.TABLE_NAME;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.AUTHORIZATIONS;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.WRITE_THREADS;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.MAX_LATENCY;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.MAX_MEMORY;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.AGEOFF_TTL;
import static nsa.datawave.security.cache.AccumuloCacheStoreConfiguration.AGEOFF_PRIORITY;
