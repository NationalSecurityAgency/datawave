...
public class ModelBean {
     ...
     * @return nsa.datawave.webservice.model.ModelList
    ...
    @Interceptors(ResponseInterceptor.class)
    public VoidResponse importModel(nsa.datawave.webservice.model.Model model,
    ...
    private VoidResponse deleteModel(@Required("name") String name, String modelTableName, boolean reloadCache) {
        ...
        nsa.datawave.webservice.model.Model model = getModel(name, modelTableName);
     ...
     * @param modelTableName
     *            name of the table that contains the model
     * @return nsa.datawave.webservice.model.Model
     * @RequestHeader X-ProxiedEntitiesChain use when proxying request for user
     *
     * @HTTP 200 success
     * @HTTP 404 model not found
    ...
    @GZIP
    @Interceptors({RequiredInterceptor.class, ResponseInterceptor.class})
    public nsa.datawave.webservice.model.Model getModel(@Required("name") @PathParam("name") String name,
                    @QueryParam("modelTableName") @DefaultValue("DatawaveMetadata") String modelTableName) {
        nsa.datawave.webservice.model.Model response = new nsa.datawave.webservice.model.Model();
    ...
    @RolesAllowed({"Administrator", "JBossAdministrator"})
    @Interceptors(ResponseInterceptor.class)
    public VoidResponse insertMapping(nsa.datawave.webservice.model.Model model,
                    @QueryParam("modelTableName") @DefaultValue("DatawaveMetadata") String modelTableName) {
        VoidResponse response = new VoidResponse();
    ...
    @RolesAllowed({"Administrator", "JBossAdministrator"})
    @Interceptors(ResponseInterceptor.class)
    public VoidResponse deleteMapping(nsa.datawave.webservice.model.Model model,
                    @QueryParam("modelTableName") @DefaultValue("DatawaveMetadata") String modelTableName) {
        return deleteMapping(model, modelTableName, true);
    }
    
    private VoidResponse deleteMapping(nsa.datawave.webservice.model.Model model, String modelTableName, boolean reloadCache) {
        VoidResponse response = new VoidResponse();
