...
import nsa.datawave.webservice.common.result.Connection;
import nsa.datawave.webservice.common.result.ConnectionFactoryResponse;
import nsa.datawave.webservice.common.result.ConnectionPool;
...
public class AccumuloConnectionFactoryBean implements AccumuloConnectionFactory {
     ...
     *
     * @return nsa.datawave.webservice.common.ConnectionFactoryResponse
