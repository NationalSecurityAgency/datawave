...
import nsa.datawave.webservice.modification.MutableMetadataHandler;
...
@MessageDriven(name = "ModificationCacheMessageBean", activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "ID:ModificationCacheMessageBean"),
