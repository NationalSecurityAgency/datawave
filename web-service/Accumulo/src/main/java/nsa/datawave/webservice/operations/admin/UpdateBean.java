...
import nsa.datawave.webservice.request.objects.ValueReference;
import nsa.datawave.webservice.response.UpdateResponse;
import nsa.datawave.webservice.response.ValidateVisibilityResponse;
...
public class UpdateBean {
        ...
        try {
            ...
            if (tableUpdateList != null) {
                ...
                for (TableUpdate next : tableUpdateList) {
                    ...
                    List<nsa.datawave.webservice.request.objects.Mutation> mutations = next.getMutations();
                    if (log.isTraceEnabled()) {
                    ...
                    try {
                        ...
                        for (nsa.datawave.webservice.request.objects.Mutation nextMutation : mutations) {
     ...
     * @HTTP 200 Success
     * @HTTP 500 AccumuloException or AccumuloSecurityException
     * @returnWrapped nsa.datawave.webservice.response.ValidateVisibilityResponse
     */
