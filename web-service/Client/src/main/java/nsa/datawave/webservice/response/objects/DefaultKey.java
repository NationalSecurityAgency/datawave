...
import nsa.datawave.webservice.query.util.TypedValue;
...
public class DefaultKey extends KeyBase {
    ...
    /*
     * (non-Javadoc) * @see nsa.datawave.webservice.response.objects.KeyInterface#getRow()
     */
    @Override
    ...
    /*
     * (non-Javadoc) * @see nsa.datawave.webservice.response.objects.KeyInterface#getColFam()
     */
    @Override
    ...
    /*
     * (non-Javadoc) * @see nsa.datawave.webservice.response.objects.KeyInterface#getColQual()
     */
    @Override
    ...
    /*
     * (non-Javadoc) * @see nsa.datawave.webservice.response.objects.KeyInterface#getTimestamp()
     */
    @Override
    ...
    /*
     * (non-Javadoc) * @see nsa.datawave.webservice.query.result.event.HasMarkings#setMarkings(java.util.Map)
     */
    @Override
    ...
    /*
     * (non-Javadoc) * @see nsa.datawave.webservice.query.result.event.HasMarkings#getMarkings()
     */
    @Override
