...
import nsa.datawave.webservice.query.result.event.MapSchema;
...
public class DefaultMetadataField extends MetadataFieldBase<DefaultMetadataField,DefaultDescription> implements Serializable, Message<DefaultMetadataField> {
    ...
    private Set<DefaultDescription> descriptions = Sets.newHashSet();
    ...
    public void setDescription(Collection<DefaultDescription> descriptions) {
        this.descriptions = Sets.newHashSet(descriptions);
    }
                ...
                switch (number) {
                    ...
                    case 8:
                        if (null == message.types) {
                            message.types = new ArrayList<String>();
                        }
                        message.types.add(input.readString());
                        break;
                    case 9:
                        int size = input.readInt32();
                        message.descriptions = Sets.newHashSetWithExpectedSize(size);
