...
public class DefaultEventQueryResponse extends EventQueryResponseBase implements TotalResultsAware, Serializable, Message<DefaultEventQueryResponse> {
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#getTotalEvents()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#getReturnedEvents()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#getFields()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#getEvents()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#setFields(java.util.List)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#setEvents(java.util.List)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see nsa.datawave.webservice.result.EventQueryResponse#getTotalResults()
     */
    @Override
