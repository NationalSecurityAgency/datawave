...
DW_ZOOKEEPER_DIST="$( { downloadTarball "${DW_ZOOKEEPER_DIST_URI}" "${DW_ACCUMULO_SERVICE_DIR}" || downloadMavenTarball "datawave-parent" "gov.nsa.datawave.quickstart" "zookeeper" "3.7.2" "${DW_ACCUMULO_SERVICE_DIR}"; } && echo "${tarball}" )"
...
# shellcheck disable=SC2034
DW_ACCUMULO_DIST="$( { downloadTarball "${DW_ACCUMULO_DIST_URI}" "${DW_ACCUMULO_SERVICE_DIR}" || downloadMavenTarball "datawave-parent" "gov.nsa.datawave.quickstart" "accumulo" "2.1.2" "${DW_ACCUMULO_SERVICE_DIR}"; } && echo "${tarball}" )"
