...
DW_HADOOP_DIST="$( { downloadTarball "${DW_HADOOP_DIST_URI}" "${DW_HADOOP_SERVICE_DIR}" || downloadMavenTarball "datawave-parent" "github-datawave::default::https://maven.pkg.github.com/NationalSecurityAgency/datawave" "gov.nsa.datawave.quickstart" "hadoop" "3.3.6" "${DW_HADOOP_SERVICE_DIR}"; } && echo "${tarball}" )"
