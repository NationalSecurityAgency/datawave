...
DW_HADOOP_DIST_URI="${DW_HADOOP_DIST_URI:-https://archive.apache.org/dist/hadoop/common/hadoop-3.1.2/hadoop-3.1.2.tar.gz}"
...
export HDFS_NAMENODE_OPTS="-Dlog4j1.compatibility=true "
export HDFS_DATANODE_OPTS="-Dlog4j1.compatibility=true "
export MAPRED_HISTORYSERVER_OPTS="-Dlog4j1.compatibility=true "
export YARN_NODEMANAGER_OPTS="-Dlog4j1.compatibility=true "
export YARN_RESOURCEMANAGER_OPTS="-Dlog4j1.compatibility=true "
