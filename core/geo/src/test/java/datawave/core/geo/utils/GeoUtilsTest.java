...
public class GeoUtilsTest {
    ...
    public void optimizeSmallAreaTest() throws Exception {
        ...
        long numUnoptimizedIndices = GeoUtils.generateTermsAndRanges(geom, GeoQueryConfig.builder().setGeoMaxExpansion(0).build()).stream()
                        .map(r -> GeoUtils.indexToPosition(r[1]) - GeoUtils.indexToPosition(r[0])).reduce(0L, Long::sum);
        long numOptimizedIndices = GeoUtils.generateTermsAndRanges(geom, GeoQueryConfig.builder().setGeoMaxExpansion(32).build()).stream()
                        .map(r -> GeoUtils.indexToPosition(r[1]) - GeoUtils.indexToPosition(r[0])).reduce(0L, Long::sum);
    ...
    public void optimizeSinglePointTest() throws Exception {
        ...
        List<String[]> optimizedRanges = GeoUtils.generateTermsAndRanges(geom, GeoQueryConfig.builder().setGeoMaxExpansion(32).build());
