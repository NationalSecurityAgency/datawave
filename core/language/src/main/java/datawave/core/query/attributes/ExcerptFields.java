...
public class ExcerptFields implements Serializable {
    ...
    public static ExcerptFields from(String string) {
        ...
        String[] fieldParts = string.split(COMMA);
        for (String fieldPart : fieldParts) {
            String[] parts = StringUtils.split(fieldPart, FORWARD_SLASH);
    ...
    public String toString() {
        ...
        while (iterator.hasNext()) {
            ...
            sb.append(entry.getKey()).append(FORWARD_SLASH).append(entry.getValue().firstKey()).append(FORWARD_SLASH)
