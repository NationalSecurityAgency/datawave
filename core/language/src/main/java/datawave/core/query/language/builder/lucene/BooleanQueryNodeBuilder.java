...
import datawave.core.query.language.tree.OrNode;
...
public class BooleanQueryNodeBuilder implements QueryBuilder {
    ...
    public datawave.core.query.language.tree.QueryNode build(QueryNode queryNode) throws QueryNodeException {
        ...
        datawave.core.query.language.tree.QueryNode bNode = null;
        List<QueryNode> children = booleanNode.getChildren();

        if (children != null) {
            List<datawave.core.query.language.tree.QueryNode> childrenList = new ArrayList<>();
            ...
            for (QueryNode child : children) {
                ...
                if (obj != null) {
                    datawave.core.query.language.tree.QueryNode query = (datawave.core.query.language.tree.QueryNode) obj;
                    childrenList.add(query);
                }
            }

            datawave.core.query.language.tree.QueryNode[] childrenArray = new datawave.core.query.language.tree.QueryNode[childrenList.size()];
    ...
    private datawave.core.query.language.tree.QueryNode createNode(QueryNode queryNode, datawave.core.query.language.tree.QueryNode[] childrenArray,
