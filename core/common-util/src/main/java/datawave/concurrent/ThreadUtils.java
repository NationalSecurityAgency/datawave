...
public final class ThreadUtils {
     ...
     */
    public static boolean blockUntil(long timeout, TimeUnit timeoutUnit, long pollIntervalMs, Supplier<Boolean> condition) throws InterruptedException {
        ...
        while (!(condition.get())) {
            ...
            Thread.sleep(Math.min(pollIntervalMs, endTime - currentTime));
        }
        return true;
    }
