...
public class AnnotationJsonUtilsTest {

    private static final Logger log = LoggerFactory.getLogger(AnnotationJsonUtilsTest.class);

    //@formatter:off
    String testAnnotationJsonWithIds = "{\n" +
            "  \"shard\": \"20250704_249\",\n" +
    ...
    String testAnnotationJsonWithoutIds = "{\n" +
            "  \"shard\": \"20250704_249\",\n" +
            "  \"dataType\": \"testDataType\",\n" +
            "  \"uid\": \"abcde.fghij.klmno\",\n" +
            "  \"documentId\": \"1234567890\",\n" +
    ...
    @Test
    public void testToJsonWithIds() throws Exception {
    ...
    @Test
    public void testToJsonWithoutIds() throws Exception {
        Annotation a = AnnotationTestDataUtil.generateTestAnnotation();
        String json = AnnotationJsonUtils.annotationToJsonWithoutIds(a);
        log.info(json);
    }

    @Test
    public void testFromJsonWithIds() throws Exception {
    ...
    @Test
    public void testFromJsonWithoutIds() throws Exception {
        Annotation expectedAnnotation = AnnotationTestDataUtil.generateTestAnnotation();
        Annotation observedAnnotation = AnnotationJsonUtils.annotationFromJson(testAnnotationJsonWithoutIds);
        AnnotationAssertions.assertAnnotationsEqual(expectedAnnotation, observedAnnotation);
        AnnotationValidators.checkAnnotation(observedAnnotation);
    }
}
