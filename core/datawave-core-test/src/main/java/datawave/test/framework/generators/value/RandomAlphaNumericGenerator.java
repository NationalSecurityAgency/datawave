...
public class RandomAlphaNumericGenerator implements ValueGenerator<String> {
    ...
    public static ValueGenerator<String> create(Random random) {
        return new RandomAlphaNumericGenerator(DEFAULT_LENGTH, random);
    }
    ...
    public static ValueGenerator<String> create(int length, Random random) {
        return new RandomAlphaNumericGenerator(length, random);
    }

    private RandomAlphaNumericGenerator(int length, Random random) {
